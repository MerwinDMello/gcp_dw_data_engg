...
config = call_config_yaml("cr_config.yaml","hca_cr_default_vars")

# get project variables from config file
bq_project_id = config['env']['v_curated_project_id']
bq_staging_dataset = config['env']['v_cr_stage_dataset_name']
stage_dataset = config['env']['v_cr_stage_dataset_name']
