...
srctableid int64;
declare
sourcesysnm,srctablename,tgttablename,audit_type,tableload_run_time,job_name,audit_status,tgtdataset_id string;
declare
...
(select arr[offset(1)]
from(
select split("{{ params.param_cr_core_dataset_name }}" , '.') as arr));
