...
BEGIN
  ...
  SET srctablename = concat(srcdataset_id, '.', 'stg_factpatienttoxicity');
...
WHERE fact_rad_onc_patient_toxicity.dw_last_update_date_time >= tableload_start_time - INTERVAL 1 MINUTE)
  );
