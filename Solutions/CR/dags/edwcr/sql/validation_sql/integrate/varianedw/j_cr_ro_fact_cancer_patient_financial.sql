...
BEGIN
  ...
  SET srctablename = concat(srcdataset_id, '.', 'consolidated_patient_encounter');
...
WHERE fact_cancer_patient_financial.dw_last_update_date_time >= tableload_start_time - INTERVAL 1 MINUTE)
  );
