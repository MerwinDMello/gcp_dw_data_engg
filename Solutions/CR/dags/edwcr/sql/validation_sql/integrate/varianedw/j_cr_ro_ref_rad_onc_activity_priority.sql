...
BEGIN
  ...
  SET srctablename = concat(srcdataset_id, '.', 'stg_dimactivitytransaction');
...
WHERE ref_rad_onc_activity_priority.dw_last_update_date_time >= tableload_start_time - INTERVAL 1 MINUTE)
  );
