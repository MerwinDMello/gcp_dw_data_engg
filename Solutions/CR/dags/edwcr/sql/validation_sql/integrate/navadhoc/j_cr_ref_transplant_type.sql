...
FROM
  (SELECT 'X' AS ccnt
   ...
   LEFT OUTER JOIN {{ params.param_cr_core_dataset_name }}.ref_transplant_type AS rtt 
   FOR SYSTEM_TIME AS OF TIMESTAMP(tableload_start_time, 'US/Central')
   ON upper(rtrim(ssc.transplant_type_name)) = upper(rtrim(rtt.transplant_type_name))
