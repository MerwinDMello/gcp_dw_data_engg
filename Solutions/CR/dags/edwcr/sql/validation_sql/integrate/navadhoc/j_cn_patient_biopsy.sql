...
BEGIN
  ...
  SET srctablename = concat(srcdataset_id, '.', 'cn_patient_biopsy_stg');
...
FROM {{ params.param_cr_base_views_dataset_name }}.cn_patient_biopsy
WHERE cn_patient_biopsy.dw_last_update_date_time >= tableload_start_time - INTERVAL 1 MINUTE)
  );
