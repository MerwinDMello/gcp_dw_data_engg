...
-- Source: eim-ops-cs-datamig-dev-0002/sql_conversion/edwcr_migration_source/edwcr_bi_views/cancer_patient_outcome_timeliness.sql
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE OR REPLACE VIEW {{ params.param_cr_bi_views_dataset_name }}.cancer_patient_outcome_timeliness AS SELECT
  ...
  FROM
    {{ params.param_cr_core_dataset_name }}.cancer_patient_outcome_timeliness AS a
