...
-- Source: eim-ops-cs-datamig-dev-0002/sql_conversion/edwcr_migration_source/{{ params.param_cr_views_dataset_name }}/navque_patient_tumor_driver.sql
...
****************************************************************************************/
CREATE OR REPLACE VIEW {{ params.param_cr_views_dataset_name }}.navque_patient_tumor_driver AS SELECT
  ...
  FROM
    {{ params.param_cr_base_views_dataset_name }}.navque_patient_tumor_driver AS a
