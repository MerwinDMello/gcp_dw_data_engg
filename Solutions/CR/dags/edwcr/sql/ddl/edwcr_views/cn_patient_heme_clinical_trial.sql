...
-- Source: eim-ops-cs-datamig-dev-0002/sql_conversion/edwcr_migration_source/{{ params.param_cr_views_dataset_name }}/cn_patient_heme_clinical_trial.sql
...
****************************************************************************************/
CREATE OR REPLACE VIEW {{ params.param_cr_views_dataset_name }}.cn_patient_heme_clinical_trial AS SELECT
    a.cn_patient_heme_clinical_trial_sid,
    a.nav_patient_id,
    a.tumor_type_id,
  ...
  FROM
    {{ params.param_cr_base_views_dataset_name }}.cn_patient_heme_clinical_trial AS a
