...
-- Source: eim-ops-cs-datamig-dev-0002/sql_conversion/edwcr_migration_source/{{ params.param_cr_views_dataset_name }}/cancer_patient_tumor_staging.sql
...
****************************************************************************************/
CREATE OR REPLACE VIEW {{ params.param_cr_views_dataset_name }}.cancer_patient_tumor_staging AS SELECT
  ...
  FROM
    {{ params.param_cr_base_views_dataset_name }}.cancer_patient_tumor_staging AS a
