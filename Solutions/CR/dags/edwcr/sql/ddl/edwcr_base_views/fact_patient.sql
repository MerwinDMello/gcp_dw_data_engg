CREATE OR REPLACE VIEW {{ params.param_cr_base_views_dataset_name }}.fact_patient
   OPTIONS(description='This table contains facts about the Patient.  This is rebuilt on a daily basis and reflects the current status of the patient.')
  AS SELECT
      ...
      fact_patient.total_midnights_in_house_amt,
      fact_patient.source_system_code,
      fact_patient.dw_last_update_date_time
    FROM
      {{ params.param_pf_base_views_dataset_name }}.fact_patient
  ;
