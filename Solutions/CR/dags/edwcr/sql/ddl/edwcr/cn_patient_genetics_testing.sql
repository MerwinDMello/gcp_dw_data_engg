CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.cn_patient_genetics_testing
(
  cn_patient_genetics_testing_sid INT64 NOT NULL OPTIONS(description='A unique identifier for each record.'),
  breast_cancer_type_id INT64 OPTIONS(description='Identifier indicating which Breast Cancer gene mutation was tested for.'),
  ...
  testing_date DATE OPTIONS(description='The date the genetics testing occurred.'),
  test_name STRING OPTIONS(description='The name of the test performed.'),
  genetics_specialist_name STRING OPTIONS(description='The name of the genetics specialist.'),
...
OPTIONS(
  description='Contains the details behind the genetics testing a patient underwent.'
);
