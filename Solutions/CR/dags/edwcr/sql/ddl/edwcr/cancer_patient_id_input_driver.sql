CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.cancer_patient_id_input_driver
(
  cancer_patient_id_input_driver_sk NUMERIC(29) NOT NULL OPTIONS(description='Unique patient key for consolidated patient input driver records'),
...
OPTIONS(
  description='Table contains the messages sent to the Cancer Id application and linked patient driver data'
);
