CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.rad_onc_junc_patient_phone
(
...
CLUSTER BY patient_sk, phone_num_type_code
OPTIONS(
  description='This table will be a junction for patient phone numbers'
);
