CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.navque_history
(
  navque_history_id INT64 NOT NULL OPTIONS(description='A unique identifier for each survivorship plan.'),
  navque_action_id INT64 NOT NULL OPTIONS(description='A five character code for each facility.'),
