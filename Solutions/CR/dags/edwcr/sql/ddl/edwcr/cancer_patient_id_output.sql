CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.cancer_patient_id_output
(
...
OPTIONS(
  description='This table contains the output of the cancer patient identifier model on HDFS.'
);
