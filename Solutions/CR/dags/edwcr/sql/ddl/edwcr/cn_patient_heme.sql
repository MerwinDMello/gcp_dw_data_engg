CREATE OR REPLACE TABLE {{ params.param_cr_core_dataset_name }}.cn_patient_heme
(
  ...
  hematologist_physician_id INT64 OPTIONS(description='Identifier for hematologist assigned to patient'),
  ...
  transportation_text STRING OPTIONS(description='Test for transportation used by patient'),
  drug_use_history_text STRING OPTIONS(description='Text for durg usgae history of the patient'),
...
OPTIONS(
  description='Contains details for Hematology patient'
);
