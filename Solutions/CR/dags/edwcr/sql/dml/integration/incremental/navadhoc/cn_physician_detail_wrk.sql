...
TRUNCATE TABLE {{ params.param_cr_stage_dataset_name }}.cn_physician_detail_stg_wrk;
...
INSERT INTO {{ params.param_cr_stage_dataset_name }}.cn_physician_detail_stg_wrk (physician_id, physician_name, physician_phone_num, dw_last_update_date_time)
...
FROM {{ params.param_cr_stage_dataset_name }}.cn_physician_detail_stg
