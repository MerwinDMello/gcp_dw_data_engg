...
TRUNCATE TABLE {{ params.param_cr_core_dataset_name }}.ref_treatment_type_group;
...
MERGE INTO {{ params.param_cr_core_dataset_name }}.ref_treatment_type_group AS mt USING
  (SELECT DISTINCT row_number() OVER (
   ...
   FROM {{ params.param_cr_stage_dataset_name }}.ref_treatment_type_group_stg) AS ms ON mt.treatment_type_group_id = ms.treatment_type_group_id
  ...
  (SELECT count(*)
   FROM
     (SELECT treatment_type_group_id
      FROM {{ params.param_cr_core_dataset_name }}.ref_treatment_type_group
...
RAISE USING MESSAGE = concat('Duplicates are not allowed in the table {{ params.param_cr_core_dataset_name }}.ref_treatment_type_group');
