...
INNER JOIN {{ params.param_cr_stage_dataset_name }}.ref_lookup_groups_stg AS t3 
ON t3.beginhisto <= SAFE_CAST(LEFT(t1.histology, 4) AS INT64)
AND t3.endhisto >= SAFE_CAST(LEFT(t1.histology, 4) AS INT64)
AND t3.beginprimarysite <= SAFE_CAST(CASE WHEN UPPER(RTRIM(RIGHT(t1.primarysite, 3))) = '***' THEN '000' ELSE RIGHT(t1.primarysite, 3) END AS INT64)
AND t3.endprimarysite >= SAFE_CAST(CASE WHEN UPPER(RTRIM(RIGHT(t1.primarysite, 3))) = '***' THEN '000' ELSE RIGHT(t1.primarysite, 3) END AS INT64)
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_cm1.groupid = SAFE_CAST(vt_lkp3.lookup_sub_code AS INT64)
  AND vt_cm1.tumorid = stg.tumorid;
...
SELECT max(t3.group_id) AS groupid,
       ...
       t1.tumorid
FROM {{ params.param_cr_stage_dataset_name }}.cr_patient_tumor_stg AS t1
INNER JOIN {{ params.param_cr_stage_dataset_name }}.ref_lookup_groups_stg AS t3 ON t3.beginhisto <= SAFE_CAST(LEFT(t1.histology, 4) AS INT64)
AND t3.endhisto >= SAFE_CAST(LEFT(t1.histology, 4) AS INT64)
AND t3.beginprimarysite <= SAFE_CAST(CASE WHEN UPPER(RTRIM(RIGHT(t1.primarysite, 3))) = '***' THEN '000' ELSE RIGHT(t1.primarysite, 3) END AS INT64)
AND t3.endprimarysite >= SAFE_CAST(CASE WHEN UPPER(RTRIM(RIGHT(t1.primarysite, 3))) = '***' THEN '000' ELSE RIGHT(t1.primarysite, 3) END AS INT64)
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_dss.groupid = SAFE_CAST(vt_lkp4.lookup_sub_code AS INT64)
  AND vt_dss.tumorid = stg.tumorid;
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_hs.groupid = SAFE_CAST(vt_lkp5.lookup_sub_code AS INT64)
  AND vt_hs.tumorid = stg.tumorid;
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_is1.groupid = SAFE_CAST(vt_lkp6.lookup_sub_code AS INT64)
  AND vt_is1.tumorid = stg.tumorid;
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_pcs.groupid = SAFE_CAST(vt_lkp8.lookup_sub_code AS INT64)
  AND vt_pcs.tumorid = stg.tumorid;
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_psss.groupid = SAFE_CAST(vt_lkp16.lookup_sub_code AS INT64)
  AND vt_psss.tumorid = stg.tumorid;
...
WHERE tu.tumor_id = stg.tumorid
  ...
  AND vt_pssh.groupid = SAFE_CAST(vt_lkp22.lookup_sub_code AS INT64)
  AND vt_pssh.tumorid = stg.tumorid;
