...
TRUNCATE TABLE {{ params.param_cr_core_dataset_name }}.cancer_patient_id_output_driver;
...
MERGE INTO {{ params.param_cr_core_dataset_name }}.cancer_patient_id_output_driver AS mt USING
...
RAISE USING MESSAGE = concat('Duplicates are not allowed in the table {{ params.param_cr_core_dataset_name }}.cancer_patient_id_output_driver');
