    ...
    def readjdbcwritebqtable(self, tableinfo, bqproject_id):
        ...
        try:
            ...
            if src_db_type == 'sqlserver':
                ...
                # jdbc_url = f"jdbc:sqlserver://{src_server_name}:{src_db_dict[0]['name'][0]};"
            ...
            print("=======================JDBC URL : {} =======================".format(jdbc_url))
            logging.info("=======================JDBC URL : {} =======================".format(jdbc_url))
            ...
            try:
                ...
                for db in src_db_dict:
                    ...
                    try:
                        ...
                        logging.info("===Unable to pull from db 1 : {} rows loaded into table {}===".format(
