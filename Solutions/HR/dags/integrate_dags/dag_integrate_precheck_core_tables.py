...
config_precheck = cu.call_config_yaml("hrg_precheck_integrate_dependency.yaml","hca_hrg_precheck_integrate_dependency")
for integrate in config_precheck['integrate']:
