...
config_lawson = cu.call_config_yaml("hrg_lawson_integrate_dependency.yaml","hca_hrg_lawson_integrate_dependency")
for integrate in config_lawson['integrate']:
