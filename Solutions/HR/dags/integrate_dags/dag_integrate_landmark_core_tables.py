...
config_landmark = cu.call_config_yaml("hrg_landmark_integrate_dependency.yaml","hca_hrg_landmark_integrate_dependency")
for integrate in config_landmark['integrate']:
