...
config_lawson_ref = cu.call_config_yaml("hrg_lawson_ref_integrate_dependency.yaml","hca_hrg_lawson_ref_integrate_dependency")
for integrate in config_lawson_ref['integrate']:
