...
config_nursing = cu.call_config_yaml("hrg_nursing_integrate_dependency.yaml","hca_hrg_nursing_integrate_dependency")
for integrate in config_nursing['integrate']:
