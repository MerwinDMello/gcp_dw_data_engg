            ...
            with TaskGroup(group_id=f'TG-table-{table}') as table_grp:
                ...
                for idx,sql in enumerate(item["sql"]):
                        update_bq_table = BigQueryOperator(
                            ...
                            sql = f'dml/integration/incremental/tms/{sql["name"]}',
...
config_tms = cu.call_config_yaml("hrg_tms_integrate_dependency.yaml","hca_hrg_tms_integrate_dependency")
for integrate in config_tms['integrate']:
