...
CREATE OR REPLACE VIEW {{ params.param_hr_bi_views_dataset_name }}.pi_rn_movement AS (
  SELECT DISTINCT
        ...
        SELECT
          ...
          WHERE dt_0.date_id >= (
            SELECT
              ...
              WHERE date_id > date_sub(current_date('US/Central'), interval 93 + extract(DAYOFWEEK from current_date('US/Central')) DAY)
               AND date_id <= current_date('US/Central')
