CREATE OR REPLACE VIEW {{ params.param_hr_bi_views_dataset_name }}.factheadcount AS SELECT
  ...
  FROM
    ...
    /*LEFT JOIN {{ params.param_hr_base_views_dataset_name }}.Employee_Position ep -- 7/6/2021 Added by Stephen for Business Needs
    ...
    LEFT OUTER JOIN --  7/6/2021 Added by Stephen for Business Needs
