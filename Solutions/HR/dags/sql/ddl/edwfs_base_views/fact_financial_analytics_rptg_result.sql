...
-- Source: eim-cs-da-gmek-5764-dev/HRG/Bteq_Source_Files/SARANYADEVI/missing_views/EDWFS_Base_Views/fact_financial_analytics_rptg_result.sql
...
/***************************************************************************************
   B A S E   V I E W
****************************************************************************************/
CREATE OR REPLACE VIEW {{ params.param_fs_base_views_dataset_name }}.fact_financial_analytics_rptg_result AS SELECT
  ...
  FROM
    {{ params.param_fs_core_dataset_name }}.fact_financial_analytics_rptg_result
;
