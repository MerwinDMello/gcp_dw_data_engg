CREATE TABLE IF NOT EXISTS {{ params.param_hr_core_dataset_name }}.recruitment_job_detail
(
...
CLUSTER BY recruitment_job_sid OPTIONS(description="Contains details around the a job based on user-defined fields in the source.");