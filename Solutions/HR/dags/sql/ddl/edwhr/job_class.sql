create table if not exists `{{ params.param_hr_core_dataset_name }}.job_class`
(
  job_class_sid INT64 NOT NULL OPTIONS(description="description of an job class code of hr company"),
  ...
  job_class_desc STRING NOT NULL OPTIONS(description="description of an job class code of hr company"),
...
CLUSTER BY job_class_sid
OPTIONS(
  description="unique values to identify class of job like technician or accountant or manager etc."
);