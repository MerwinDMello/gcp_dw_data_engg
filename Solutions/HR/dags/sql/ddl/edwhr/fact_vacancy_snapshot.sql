CREATE TABLE IF NOT EXISTS {{ params.param_hr_core_dataset_name }}.fact_vacancy_snapshot (
...
, period_end_date DATE OPTIONS(description="The last day of the month that the metric was calculated for the given dimensions.")
...
OPTIONS(description="A table used for reporting that contains snapshots of information for unfilled job position based on calculations from Fact_HR_Metric_Snapshot.");
