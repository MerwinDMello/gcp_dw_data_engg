create table if not exists `{{ params.param_hr_core_dataset_name }}.fact_hr_metric_snapshot`
(
  ...
  metric_denominator_qty NUMERIC(18, 6) OPTIONS(description=" This is the total population against which the metric is being tracked."),
  source_system_code STRING NOT NULL OPTIONS(description=" A one character code indicating the specific source system from which the data originated."),
  dw_last_update_date_time DATETIME NOT NULL OPTIONS(description=" Timestamp of update or load of this record to the Enterprise Data Warehouse.")
)
CLUSTER BY employee_sid, requisition_sid, position_sid, analytics_msr_sid
OPTIONS(
  description=" This is a snapshot table that contains facts used for HR reporting from source systems including Lawson, HRA, Finance, Performance Improvement."
);