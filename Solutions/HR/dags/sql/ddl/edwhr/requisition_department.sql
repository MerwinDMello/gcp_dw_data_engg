create table if not exists `{{ params.param_hr_core_dataset_name }}.requisition_department`
(
  ...
  dept_code STRING NOT NULL OPTIONS(description="this field contains value of department code of an company"),
...
OPTIONS(
  description="unique requisition created against department and its history maintained in this table"
);