CREATE TABLE IF NOT EXISTS {{ params.param_hr_core_dataset_name }}.offer_detail
(
...
OPTIONS(description="Contains details around the offer based on different element types.");
