create or replace view `{{ params.param_hr_base_views_dataset_name }}.ref_lawson_location_hospital_category`
AS SELECT
  ...
  FROM
   {{ params.param_hr_core_dataset_name }}.ref_lawson_location_hospital_category;