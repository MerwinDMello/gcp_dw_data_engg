...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.process_level_address AS SELECT
      a.process_level_sid,
      a.valid_from_date,
      a.addr_sid,
      a.valid_to_date,
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.process_level_address AS a
