...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.process_level AS SELECT
      a.process_level_sid,
      a.valid_from_date,
      a.valid_to_date,
      a.hr_company_sid,
      ...
      a.process_level_active_code,
      a.active_dw_ind,
      a.security_key_text,
      a.source_system_code,
      a.dw_last_update_date_time
    FROM
      {{ params.param_hr_base_views_dataset_name }}.process_level AS a
