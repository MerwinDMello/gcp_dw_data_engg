...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.requisition_department AS SELECT
      a.requisition_sid,
      a.valid_from_date,
      a.dept_sid,
      a.valid_to_date,
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.requisition_department AS a
