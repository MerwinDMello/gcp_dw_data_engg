...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.ref_hr_process_level_abbreviation AS SELECT
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.ref_hr_process_level_abbreviation
  ;
