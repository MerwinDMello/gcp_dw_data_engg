...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.ref_bi_movement_reason AS SELECT
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.ref_bi_movement_reason
  ;
