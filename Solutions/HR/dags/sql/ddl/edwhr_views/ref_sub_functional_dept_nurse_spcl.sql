...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.ref_sub_functional_dept_nurse_spcl AS SELECT
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.ref_sub_functional_dept_nurse_spcl
  ;
