...
****************************************************************************************/
  ...
  CREATE OR REPLACE VIEW {{ params.param_hr_views_dataset_name }}.bi_employee_detail_snapshot AS SELECT
      a.employee_sid,
      a.snapshot_date,
      a.employee_num,
      CASE
    ...
    FROM
      {{ params.param_hr_base_views_dataset_name }}.bi_employee_detail_snapshot AS a
