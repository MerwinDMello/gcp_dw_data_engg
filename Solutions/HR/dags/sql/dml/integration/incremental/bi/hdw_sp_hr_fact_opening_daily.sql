--###############################################################################################
--#                                                                                   			#
--# Target Table - {{ params.param_hr_core_dataset_name }}.Fact_Opening_Daily            											#
--#                                                                                   			#
--# CHANGE CONTROL:                                                                   			#
--#                                                                                   			#
...
--#                                                                                   			#
--#                                                                                   			#
--#  This will load {{ params.param_hr_core_dataset_name }}.Fact_Opening_Daily      												#
--###############################################################################################
...
set end_date = datetime_trunc(current_datetime('US/Central'), second);
