...
srctablename = Null;
SET
tgttablename = 'edwhr.employee_detail';
SET
...
from 
(
select hre.employee, hre.company, hre.emp_app, hre.field_key 
from  {{ params.param_hr_stage_dataset_name }}.hrempusf hre

inner join {{ params.param_hr_stage_dataset_name }}.employee eid
on (hre.employee) = (eid.employee) 
and (hre.company) = (eid.company)
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.employee_detail
