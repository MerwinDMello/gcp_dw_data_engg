...
select  
  *
from {{ params.param_hr_stage_dataset_name }}.hrposusd h
    inner join {{ params.param_hr_core_dataset_name }}.job_position j
    on h.obj_id = j.lawson_object_id 
    and
    h.company = j.lawson_company_num 
    and 
    h.effect_date = j.eff_from_date
    and
    j.source_system_code='L'
    and 
    j.valid_to_date = '9999-12-31'
));
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.job_position_detail
