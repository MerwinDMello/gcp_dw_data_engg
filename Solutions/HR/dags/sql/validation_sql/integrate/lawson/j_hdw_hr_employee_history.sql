...
FROM
  ...
  LEFT OUTER JOIN {{ params.param_hr_core_dataset_name }}.hr_employee_history AS tgt 
  for system_time as of timestamp(tableload_start_time,'US/Central') 
  ON tgt.employee_sid = stg.employee_sid
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.hr_employee_history
