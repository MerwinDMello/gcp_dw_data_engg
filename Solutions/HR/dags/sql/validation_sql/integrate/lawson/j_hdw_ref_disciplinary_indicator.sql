...
select  
  *
from {{ params.param_hr_stage_dataset_name }}.ref_disciplinary_indicator_wrk stg

left join {{ params.param_hr_core_dataset_name }}.ref_disciplinary_indicator tgt for system_time as of timestamp(tableload_start_time,'US/Central') 
on stg.disciplinary_ind = tgt.disciplinary_ind
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.ref_disciplinary_indicator
