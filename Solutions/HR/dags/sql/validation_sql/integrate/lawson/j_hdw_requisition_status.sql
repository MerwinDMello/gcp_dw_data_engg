...
{{ params.param_hr_stage_dataset_name }}.requisition_status_wrk AS wrk
  LEFT OUTER JOIN {{ params.param_hr_core_dataset_name }}.requisition_status AS tgt for system_time as of timestamp(tableload_start_time,'US/Central') 
  ON tgt.requisition_sid = wrk.requisition_sid
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.requisition_status
