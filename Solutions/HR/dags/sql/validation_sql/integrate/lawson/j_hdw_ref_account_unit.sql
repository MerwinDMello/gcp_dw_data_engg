...
from 
(
select distinct acct_unit as account_unit_code, ' ' as account_unit_desc
from 
{{ params.param_hr_stage_dataset_name }}.zxauxref
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.ref_account_unit
