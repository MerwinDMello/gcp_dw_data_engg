...
select  
  *
from
  {{ params.param_hr_stage_dataset_name }}.prsaghead
));
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.company_pay_schedule
where  active_dw_ind = 'Y' AND source_system_code = 'L') ;
