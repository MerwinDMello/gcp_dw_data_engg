...
srctablename = Null;
SET
tgttablename = concat('edwhr.','personnel_time');
SET
...
(
SELECT
cast(employee_num as int64) as employee_num,
lpad(process_level_code, 5, '0') as process_level_code,
trim(clock_library_code) as clock_library_code,
current_ts as dw_last_update_date_time
from {{ params.param_hr_stage_dataset_name }}.krono_combined_edw_employee
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.personnel_time
