...
srctablename = Null;
SET
tgttablename = concat('edwhr.','time_entry');
SET
...
from {{ params.param_hr_stage_dataset_name }}.time_entry_wrk stg

left join {{ params.param_hr_core_dataset_name }}.time_entry as tgt for system_time as of timestamp(tableload_start_time,'US/Central')
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.time_entry
