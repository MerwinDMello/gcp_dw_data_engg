...
srctablename = Null;
SET
tgttablename = concat('edwhr.','ref_exception');
SET
...
from {{ params.param_hr_stage_dataset_name }}.ref_exception rc
group by 1,2,3,4
)stg);
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.ref_exception
