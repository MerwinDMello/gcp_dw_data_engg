...
srctablename = Null;
SET
tgttablename = concat('edwhr.','pay_code_pay_summary_group_crosswalk');
SET
...
trim(pcpsgc.pay_summary_group) as pay_summary_group_code,
trim(pcpsgc.kronos_payroll_interface_code) as payroll_interface_code,
pcpsgc.source_system_code,
current_ts as dw_last_update_date_time
from {{ params.param_hr_stage_dataset_name }}.pay_code_pay_summary_group_crosswalk_stg pcpsgc
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.pay_code_pay_summary_group_crosswalk
