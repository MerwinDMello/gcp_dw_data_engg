...
srctablename = Null;
SET
tgttablename = 'edwhr.recruitment_requisition_status';
SET
...
SELECT
      ...
      FROM
        ...
        LEFT OUTER JOIN {{ params.param_hr_core_dataset_name }}.recruitment_requisition_status AS tgt for system_time as of timestamp(tableload_start_time,'US/Central')
         ON stg.recruitment_requisition_sid = tgt.recruitment_requisition_sid
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.recruitment_requisition_status
