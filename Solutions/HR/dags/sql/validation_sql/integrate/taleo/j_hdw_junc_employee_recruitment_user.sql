...
srctablename = Null;
SET
tgttablename = 'edwhr.junc_employee_recruitment_user';
SET
...
WHERE
  ...
  FROM
    {{ params.param_hr_core_dataset_name }}.junc_employee_recruitment_user AS tgt for system_time as of timestamp(tableload_start_time,'US/Central')
  WHERE
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.junc_employee_recruitment_user
