...
srctablename = Null;
SET
tgttablename = 'edwhr.ref_requisition_status';
SET
...
LEFT OUTER JOIN {{ params.param_hr_core_dataset_name }}.ref_requisition_status AS tgt_0 
for system_time as of timestamp(tableload_start_time,'US/Central') 
ON trim(tgt_0.status_desc) = stg.description
