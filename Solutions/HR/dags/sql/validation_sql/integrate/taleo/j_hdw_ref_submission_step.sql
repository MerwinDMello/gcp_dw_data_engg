...
srctablename = Null;
SET
tgttablename = 'edwhr.ref_submission_step';
SET
...
SELECT
    ...
    DATETIME_TRUNC(CURRENT_DATETIME('US/Central'), SECOND) AS dw_last_update_date_time
FROM
    {{ params.param_hr_stage_dataset_name }}.ats_hcm_atsworkflowcategory_stg AS wc
GROUP BY 1, 2, 3, 4, 5, 6, 7, 8, 9));
...
tgt_rec_count =
(SELECT count(*)
FROM {{ params.param_hr_core_dataset_name }}.ref_submission_step
