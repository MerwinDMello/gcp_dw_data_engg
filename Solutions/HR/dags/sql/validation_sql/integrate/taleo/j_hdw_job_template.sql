...
srctablename = Null;
SET
tgttablename = 'edwhr.job_template';
SET
...
LEFT OUTER JOIN
  {{ params.param_hr_core_dataset_name }}.job_template AS tgt for system_time as of timestamp(tableload_start_time,'US/Central')
ON
...
tgt_rec_count =
(select count(*)
from {{ params.param_hr_base_views_dataset_name }}.job_template
