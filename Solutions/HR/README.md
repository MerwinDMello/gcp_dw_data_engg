...
This repository contains the code for ingestion and integration of data for EDWHR. Each major folder contains a README with additional context for its contents.
...
Any specific variations from the general HIN GitHub standards/conventions particular to this LoB's repository should be detailed in this section.
