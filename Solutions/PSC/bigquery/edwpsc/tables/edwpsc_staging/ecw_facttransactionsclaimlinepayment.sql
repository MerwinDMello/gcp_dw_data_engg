CREATE TABLE IF NOT EXISTS edwpsc_staging.ecw_facttransactionsclaimlinepayment
(
  transactionsclaimlinepaymentskey INT64 NOT NULL,
  ...
  sourceprimarykey INT64 NOT NULL,
