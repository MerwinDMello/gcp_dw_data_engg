CREATE TABLE IF NOT EXISTS edwpsc_staging.pv_facttransactionsclaimlinefinancialadjustment
(
  transctionsclaimlinefinancialadjustmentkey INT64 NOT NULL,
  claimkey INT64,
  claimnumber INT64,
  regionkey INT64,
  coid STRING,
  ...
  PRIMARY KEY (transctionsclaimlinefinancialadjustmentkey) NOT ENFORCED
)
;