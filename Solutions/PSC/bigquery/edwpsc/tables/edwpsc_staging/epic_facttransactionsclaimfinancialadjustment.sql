CREATE TABLE IF NOT EXISTS edwpsc_staging.epic_facttransactionsclaimfinancialadjustment
(
  transactionsclaimfinancialadjustmentkey INT64 NOT NULL,
  ...
  PRIMARY KEY (transactionsclaimfinancialadjustmentkey) NOT ENFORCED
)
;