CREATE OR REPLACE VIEW edwpsc_base_views.`epic_facttransactionsclaimlinecontractualadjustment`
AS SELECT
  ...
  FROM
    edwpsc.`epic_facttransactionsclaimlinecontractualadjustment`
;