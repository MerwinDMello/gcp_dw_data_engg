CREATE OR REPLACE VIEW edwpsc_base_views.`epic_factsnapshotencounterswithoutclaimswithpayments`
AS SELECT
  ...
  FROM
    edwpsc.`epic_factsnapshotencounterswithoutclaimswithpayments`
;