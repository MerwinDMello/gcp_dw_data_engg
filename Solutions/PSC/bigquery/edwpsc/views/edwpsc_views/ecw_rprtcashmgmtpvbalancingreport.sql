CREATE OR REPLACE VIEW edwpsc_views.`ecw_rprtcashmgmtpvbalancingreport`
AS SELECT
  ...
  FROM
    edwpsc_base_views.`ecw_rprtcashmgmtpvbalancingreport`
  INNER JOIN edwpsc_base_views.secref_facility
  ON LPAD(TRIM(secref_facility.co_id, ' '), 5, '0') = LPAD(TRIM(`ecw_rprtcashmgmtpvbalancingreport`.coid, ' '), 5, '0')
