CREATE OR REPLACE VIEW edwpsc_views.`ecw_factclaimfinancialadjustment`
AS SELECT
  ...
  FROM
    edwpsc_base_views.`ecw_factclaimfinancialadjustment`
  INNER JOIN edwpsc_base_views.secref_facility
  ON LPAD(TRIM(secref_facility.co_id, ' '), 5, '0') = LPAD(TRIM(`ecw_factclaimfinancialadjustment`.coid, ' '), 5, '0')
