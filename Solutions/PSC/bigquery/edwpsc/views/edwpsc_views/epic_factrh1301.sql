CREATE OR REPLACE VIEW edwpsc_views.`epic_factrh1301`
AS SELECT
  ...
  FROM
    edwpsc_base_views.`epic_factrh1301`
  INNER JOIN edwpsc_base_views.secref_facility
  ON LPAD(TRIM(secref_facility.co_id, ' '), 5, '0') = LPAD(TRIM(`epic_factrh1301`.coid, ' '), 5, '0')
