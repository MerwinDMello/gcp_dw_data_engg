...
- bigquery
    - subdomain folder
        ...
        - views: scripts for views - OK to include multiple views in single script, place in order they should be created (e.g. base view should be before view)
        - udfs: scripts for user defined functions
