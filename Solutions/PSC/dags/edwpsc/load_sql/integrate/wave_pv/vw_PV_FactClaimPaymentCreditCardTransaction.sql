...
TRUNCATE TABLE {{ params.param_psc_core_dataset_name }}.vw_PV_FactClaimPaymentCreditCardTransaction ;

INSERT INTO {{ params.param_psc_core_dataset_name }}.vw_PV_FactClaimPaymentCreditCardTransaction (ClaimKey, LogDetailPK, CreditCardType, CCSaleType, CreatedCardDate, ReserveAmt, ReserveAmtUsed, ReserveAmtRemaining, DeletedFlag, DeclinedOrCancelledFlag, DeclinedAmt, RegionKey, DWLastUpdateDateTime, SourceSystemCode, InsertedBy, InsertedDTM, ModifiedBy, ModifiedDTM, LoadKey)
