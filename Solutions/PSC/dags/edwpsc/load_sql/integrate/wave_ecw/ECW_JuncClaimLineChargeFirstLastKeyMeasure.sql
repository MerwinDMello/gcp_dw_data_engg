...
MERGE INTO {{ params.param_psc_core_dataset_name }}.ECW_JuncClaimLineChargeFirstLastKeyMeasure AS target
USING {{ params.param_psc_stage_dataset_name }}.ECW_JuncClaimLineChargeFirstLastKeyMeasure AS source
...
WHEN MATCHED THEN
 ...
 target.SecondToLastDenialERADateKey = source.SecondToLastDenialERADateKey,
 target.SecondToLastDenialCarcRarcCode = TRIM(source.SecondToLastDenialCarcRarcCode),
 target.SecondToLastDenialCARCCodes = TRIM(source.SecondToLastDenialCARCCodes),
 target.SecondToLastDenialRARCCodes = TRIM(source.SecondToLastDenialRARCCodes),
 target.SecondToLastDenialPayerName = TRIM(source.SecondToLastDenialPayerName),
 target.SecondToLastDenialCarcRarcType = TRIM(source.SecondToLastDenialCarcRarcType),
 target.SecondToLastDenialCARCIsDenial = TRIM(source.SecondToLastDenialCARCIsDenial),
 target.SecondToLastDenialCARCRequiresRarc = TRIM(source.SecondToLastDenialCARCRequiresRarc),
 target.SecondToLastDenialCategory = TRIM(source.SecondToLastDenialCategory),
 target.SecondToLastDenialRARCIsDenial = TRIM(source.SecondToLastDenialRARCIsDenial),
 target.ThirdToLastDenialERADateKey = source.ThirdToLastDenialERADateKey,
 target.ThirdToLastDenialCarcRarcCode = TRIM(source.ThirdToLastDenialCarcRarcCode),
 target.ThirdToLastDenialCARCCodes = TRIM(source.ThirdToLastDenialCARCCodes),
 target.ThirdToLastDenialRARCCodes = TRIM(source.ThirdToLastDenialRARCCodes),
 target.ThirdToLastDenialPayerName = TRIM(source.ThirdToLastDenialPayerName),
 target.ThirdToLastDenialCarcRarcType = TRIM(source.ThirdToLastDenialCarcRarcType),
 target.ThirdToLastDenialCARCIsDenial = TRIM(source.ThirdToLastDenialCARCIsDenial),
 target.ThirdToLastDenialCARCRequiresRarc = TRIM(source.ThirdToLastDenialCARCRequiresRarc),
 target.ThirdToLastDenialCategory = TRIM(source.ThirdToLastDenialCategory),
 target.ThirdToLastDenialRARCIsDenial = TRIM(source.ThirdToLastDenialRARCIsDenial),
 target.FourthToLastDenialERADateKey = source.FourthToLastDenialERADateKey,
 target.FourthToLastDenialCarcRarcCode = TRIM(source.FourthToLastDenialCarcRarcCode),
 target.FourthToLastDenialCARCCodes = TRIM(source.FourthToLastDenialCARCCodes),
 target.FourthToLastDenialRARCCodes = TRIM(source.FourthToLastDenialRARCCodes),
 target.FourthToLastDenialPayerName = TRIM(source.FourthToLastDenialPayerName),
 target.FourthToLastDenialCarcRarcType = TRIM(source.FourthToLastDenialCarcRarcType),
 target.FourthToLastDenialCARCIsDenial = TRIM(source.FourthToLastDenialCARCIsDenial),
 target.FourthToLastDenialCARCRequiresRarc = TRIM(source.FourthToLastDenialCARCRequiresRarc),
 target.FourthToLastDenialCategory = TRIM(source.FourthToLastDenialCategory),
 target.FourthToLastDenialRARCIsDenial = TRIM(source.FourthToLastDenialRARCIsDenial),
 target.SecondToLastERADateKey = source.SecondToLastERADateKey,
 target.SecondToLastERACARCCodes = TRIM(source.SecondToLastERACARCCodes),
 target.SecondToLastERARARCCodes = TRIM(source.SecondToLastERARARCCodes),
 target.SecondToLastERAPayerName = TRIM(source.SecondToLastERAPayerName),
 target.ThirdToLastERADateKey = source.ThirdToLastERADateKey,
 target.ThirdToLastERACARCCodes = TRIM(source.ThirdToLastERACARCCodes),
 target.ThirdToLastERARARCCodes = TRIM(source.ThirdToLastERARARCCodes),
 target.ThirdToLastERAPayerName = TRIM(source.ThirdToLastERAPayerName),
 target.FourthToLastERADateKey = source.FourthToLastERADateKey,
 target.FourthToLastERACARCCodes = TRIM(source.FourthToLastERACARCCodes),
 target.FourthToLastERARARCCodes = TRIM(source.FourthToLastERARARCCodes),
 target.FourthToLastERAPayerName = TRIM(source.FourthToLastERAPayerName),
 target.LineBalanceCashValueAmt = source.LineBalanceCashValueAmt,
...
IF DUP_COUNT <> 0 THEN
  ...
  RAISE USING MESSAGE = CONCAT('Duplicates are not allowed in the table {{ params.param_psc_core_dataset_name }}.ECW_JuncClaimLineChargeFirstLastKeyMeasure');
ELSE
  COMMIT TRANSACTION;
END IF;
