...
## NOTE: You are unlikely to do this set up in this repository as secrets to be deployed to GSM should be handled through the HCA-PDM/gcp-hin-parallon repo, but the info below will help you get the relevant information and code ready to deploy through that repo.
