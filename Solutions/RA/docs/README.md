...
- Our recommendation is to set up a team of code owners and require code owner approval for Pull Requests into the prd branch via branch rules
- You may additionally (or instead) wish to use branch rules to limit who can complete merges into the prd branch
