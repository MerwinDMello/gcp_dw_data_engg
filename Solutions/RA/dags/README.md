...
1. If there is an additional grouping of DAGs that is relevant for this repo, feel free to add a folder associated with it.
2. Add dataset folders within the ddl folder
3. Delete any placeholder files (.gitkeep) as actual content is added

(end of section to delete upon completing setup)

# A Note About File Path References in Scripts
The code below is the recommended syntax to use to reference file paths in your scripts
