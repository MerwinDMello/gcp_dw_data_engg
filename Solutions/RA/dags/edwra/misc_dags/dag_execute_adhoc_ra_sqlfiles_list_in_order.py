...
default_args = {
    ...
    'params': {
        ...
        "param_parallon_ra_base_views_dataset_name": bq_project_id + '.' + config['env'][
            'v_parallon_ra_base_views_dataset_name'],
...
with DAG(
        "dag_execute_adhoc_ra_sqlfiles_list_in_order",
    ...
    sqlfilelist = Variable.get("var_ra_sqlfilelist", deserialize_json=True)
