...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_base_views/physician_detail_crnt.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE OR REPLACE VIEW {{ params.param_parallon_ra_base_views_dataset_name }}.physician_detail_crnt AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.physician_detail_crnt
;
