...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_base_views/fact_patient.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE OR REPLACE VIEW {{ params.param_parallon_ra_base_views_dataset_name }}.fact_patient AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.fact_patient
;
