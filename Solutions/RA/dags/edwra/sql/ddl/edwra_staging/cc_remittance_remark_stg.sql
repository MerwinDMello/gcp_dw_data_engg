...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/cc_remittance_remark_stg.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.cc_remittance_remark_stg
(
