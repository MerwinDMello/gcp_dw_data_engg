...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/reimbursement_discrepancy_wrk1.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.reimbursement_discrepancy_wrk1
(
