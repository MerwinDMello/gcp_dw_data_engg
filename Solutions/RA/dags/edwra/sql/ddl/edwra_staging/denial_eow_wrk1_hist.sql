...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/denial_eow_wrk1_hist.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.denial_eow_wrk1_hist
(
