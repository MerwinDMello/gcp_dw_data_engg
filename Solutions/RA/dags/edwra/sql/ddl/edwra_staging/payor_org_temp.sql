...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/payor_org.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.payor_org_temp
(
