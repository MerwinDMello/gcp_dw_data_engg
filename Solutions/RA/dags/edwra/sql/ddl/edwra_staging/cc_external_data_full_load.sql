...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/cc_external_data_full_load.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.cc_external_data_full_load
(
  ...
  first_psr_note_date_time DATETIME,
  last_psr_note_date_time DATETIME
)
