...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/cc_reimb_lifecycle_event_merge.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.cc_reimb_lifecycle_event_merge
(
  ...
  reimb_lifecycle_id BIGNUMERIC(38) NOT NULL,
