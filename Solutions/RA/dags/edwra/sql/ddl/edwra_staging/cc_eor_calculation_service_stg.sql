...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_staging/cc_eor_calculation_service_stg.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_stage_dataset_name }}.cc_eor_calculation_service_stg
(
  ...
  ipf_labor_share_amt NUMERIC(31, 2),
  ...
  ipf_pps_los_adj_fctr_pct NUMERIC(31, 2),
