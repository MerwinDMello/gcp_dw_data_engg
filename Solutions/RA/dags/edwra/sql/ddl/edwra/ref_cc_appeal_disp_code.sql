...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/ref_cc_appeal_disp_code.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.ref_cc_appeal_disp_code
(
