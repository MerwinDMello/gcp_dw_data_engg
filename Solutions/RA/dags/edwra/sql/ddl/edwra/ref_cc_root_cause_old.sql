...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/ref_cc_root_cause_old.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.ref_cc_root_cause_old
(
