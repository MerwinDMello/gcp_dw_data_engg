...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/cc_remit_reimb_amount.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.cc_remit_reimb_amount
(
