...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/cc_eor_amount.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.cc_eor_amount
(
  ...
  reimbursement_method_type_code STRING NOT NULL,
  amount_category_code INT64 NOT NULL,
  unit_num STRING NOT NULL,
  pat_acct_num NUMERIC(29),
  iplan_id INT64,
  eor_reimbursement_amt NUMERIC(32, 3),
