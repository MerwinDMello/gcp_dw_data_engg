...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/cc_appeal_seq_pbi19656.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.cc_appeal_seq_pbi19656
(
