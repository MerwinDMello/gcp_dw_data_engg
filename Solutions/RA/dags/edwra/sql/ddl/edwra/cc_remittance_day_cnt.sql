...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra/cc_remittance_day_cnt.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE TABLE IF NOT EXISTS {{ params.param_parallon_ra_core_dataset_name }}.cc_remittance_day_cnt
(
