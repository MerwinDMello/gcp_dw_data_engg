...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwra_views/rh_837_patient_procedure.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE OR REPLACE VIEW {{ params.param_parallon_ra_views_dataset_name }}.rh_837_patient_procedure
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_parallon_ra_base_views_dataset_name }}.rh_837_patient_procedure AS a
