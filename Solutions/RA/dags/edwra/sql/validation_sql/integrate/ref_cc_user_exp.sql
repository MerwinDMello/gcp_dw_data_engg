...
SET srctablename = concat(srcdataset_id, '.','users' ); -- This needs to be added
...
select count(*) as row_count
   ...
   INNER JOIN {{ params.param_parallon_ra_core_dataset_name }}.ref_cc_org_structure AS rccos ON rccos.schema_id = usr.schema_id) a
);
