...
config = call_config_yaml("edwrmt_config.yaml")
    ...
    def readjdbcwritebqtable(self, tableinfo, bqproject_id):
        ...
        try:
            ...
            tgttablename = tgttablename.replace(
                'v_rmt_stage_dataset_name', config['env']['v_rmt_stage_dataset_name'])
            tgttablename = tgttablename.replace(
                'v_rmt_core_dataset_name', config['env']['v_rmt_core_dataset_name'])
