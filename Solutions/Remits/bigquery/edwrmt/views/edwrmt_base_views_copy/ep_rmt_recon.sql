CREATE OR REPLACE VIEW {{ params.param_rmt_mirrored_base_views_dataset_name }}.ep_rmt_recon
AS SELECT
  ...
  FROM
     {{ params.param_mirroring_project_id }}.{{ params.param_rmt_mirrored_core_dataset_name }}.ep_rmt_recon
;
