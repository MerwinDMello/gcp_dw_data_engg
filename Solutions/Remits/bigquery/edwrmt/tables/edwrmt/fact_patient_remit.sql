CREATE TABLE IF NOT EXISTS {{ params.param_rmt_core_dataset_name }}.fact_patient_remit
(
  ...
  customer_cd STRING,
  PRIMARY KEY (customer_cd, patient_remit_sid) NOT ENFORCED
)
CLUSTER BY customer_cd, patient_remit_sid;
