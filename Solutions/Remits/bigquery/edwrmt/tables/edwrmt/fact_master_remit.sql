CREATE TABLE IF NOT EXISTS {{ params.param_rmt_core_dataset_name }}.fact_master_remit
(
  ...
  PRIMARY KEY (customer_cd, remit_id) NOT ENFORCED
)
CLUSTER BY customer_cd, remit_id;
