CREATE TABLE IF NOT EXISTS {{ params.param_rmt_core_dataset_name }}.fact_svc_line
(
  ...
  proc_mod_4 STRING,
  customer_cd STRING,
  PRIMARY KEY (customer_cd, svc_line_seq_num, patient_remit_sid) NOT ENFORCED
)
CLUSTER BY customer_cd, svc_line_seq_num, patient_remit_sid;
