CREATE OR REPLACE VIEW {{ params.param_clm_mirrored_base_views_dataset_name }}.secref_facility
AS
SELECT
...
UNION DISTINCT
	SELECT
		...
		co_id
	FROM 
	{{ params.param_clm_mirrored_base_views_dataset_name }}.hin_secref_facility
UNION DISTINCT
SELECT
	company_code,
	user_id,
