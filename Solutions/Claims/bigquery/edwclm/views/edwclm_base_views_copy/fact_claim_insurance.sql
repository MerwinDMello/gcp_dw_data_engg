CREATE OR REPLACE VIEW {{ params.param_clm_mirrored_base_views_dataset_name }}.fact_claim_insurance
AS SELECT
  ...
  FROM
    {{ params.param_mirroring_project_id }}.{{ params.param_clm_mirrored_core_dataset_name }}.fact_claim_insurance
;
