CREATE OR REPLACE VIEW `hca-hin-dev-cur-clinical.edwclin_ac.bq_query_history`
AS
SELECT
...
FROM (
  ...
  FROM
    `hca-hin-dev-cur-clinical.auth_base_views.cloudaudit_googleapis_com_data_access`
  WHERE
