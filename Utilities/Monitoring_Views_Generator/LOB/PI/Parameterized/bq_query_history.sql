CREATE OR REPLACE VIEW `{{ params.param_monitoring_views_dataset_name }}.bq_query_history`
AS
SELECT
...
FROM (
  ...
  FROM
    `{{ params.param_auth_base_views_dataset_name }}.cloudaudit_googleapis_com_data_access`
  WHERE
