...
-- ##################################################################################
-- bteq << EOF >> $1;
-- SET QUERY_BAND = 'App=EDWCR_ETL; Job=J_REF_FACILITY;' FOR SESSION;
...
BEGIN
  ...
  ON mt.facility_id = ms.facility_id
   ...
   AND mt.dw_last_update_date_time = ms.dw_last_update_date_time
     WHEN NOT MATCHED BY TARGET THEN
      INSERT (facility_id, facility_name, source_system_code, dw_last_update_date_time)
