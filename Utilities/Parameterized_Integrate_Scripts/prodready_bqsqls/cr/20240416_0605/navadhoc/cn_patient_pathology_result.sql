...
MERGE INTO {{ params.param_cr_core_dataset_name }}.cn_patient_pathology_result AS mt USING
  (SELECT DISTINCT cn_patient_pathology_result_stg.cn_patient_pathology_res_sid,
   ...
   WHERE upper(cn_patient_pathology_result_stg.hashbite_ssk) NOT IN
       (SELECT upper(cn_patient_pathology_result.hashbite_ssk) AS hashbite_ssk
        FROM {{ params.param_cr_core_dataset_name }}.cn_patient_pathology_result) ) AS ms ON mt.cn_patient_pathology_result_sid = ms.cn_patient_pathology_res_sid
...
RAISE USING MESSAGE = concat('Duplicates are not allowed in the table {{ params.param_cr_core_dataset_name }}.cn_patient_pathology_result');
