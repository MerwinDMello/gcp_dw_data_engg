...
DELETE
FROM `hca-hin-dev-cur-ops`.edwcr.cn_patient_survivorship_plan_task
WHERE upper(cn_patient_survivorship_plan_task.hashbite_ssk) NOT IN
    (SELECT upper(cn_patient_survivorship_plan_task_stg.hashbite_ssk) AS hashbite_ssk
     FROM `hca-hin-dev-cur-ops`.edwcr_staging.cn_patient_survivorship_plan_task_stg);
...
MERGE INTO `hca-hin-dev-cur-ops`.edwcr.cn_patient_survivorship_plan_task AS mt USING
  (SELECT DISTINCT stg.nav_survivorship_plan_task_sid,
   ...
   FROM `hca-hin-dev-cur-ops`.edwcr_staging.cn_patient_survivorship_plan_task_stg AS stg
   ...
   WHERE upper(stg.hashbite_ssk) NOT IN
       (SELECT upper(cn_patient_survivorship_plan_task.hashbite_ssk) AS hashbite_ssk
        FROM `hca-hin-dev-cur-ops`.edwcr.cn_patient_survivorship_plan_task) ) AS ms ON mt.nav_survivorship_plan_task_sid = ms.nav_survivorship_plan_task_sid
...
RAISE USING MESSAGE = concat('Duplicates are not allowed in the table `hca-hin-dev-cur-ops`.edwcr.cn_patient_survivorship_plan_task');
