...
-- Source: eim-clin-pdoc-ccda-dev-0001/ca_bulk_conversion_validation/20231201_0618/input/act/j_cdm_adhoc_ca_perfusion_tmp_site_prm.sql
-- Translated from: Teradata
-- Translated to: BigQuery

SELECT count(*)
FROM
  (SELECT ca_perfusion_tmp_site.*
   FROM {{ params.param_clinical_cdm_core_dataset_name }}.ca_perfusion_tmp_site
   WHERE ca_perfusion_tmp_site.dw_last_update_date_time >=
