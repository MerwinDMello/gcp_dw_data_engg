...
-- Source: eim-parallon-cs-datamig-dev-0002/pbs_bulk_conversion_validation/20231106_1249/input/act/ar_pbs_j_pf_fact_pat_upfrntcol_prm.sql
-- Translated from: Teradata
-- Translated to: BigQuery
 -- Locking table edwpbs.Fact_RCOM_AR_Patient_Level for access

SELECT coalesce(CAST(sum(fact_rcom_ar_patient_level.payor_up_front_collection_amt) AS STRING), '0') AS source_string
