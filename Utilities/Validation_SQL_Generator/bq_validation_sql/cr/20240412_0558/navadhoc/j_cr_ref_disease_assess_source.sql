...
FROM
  (SELECT 'X' AS ccnt
   ...
   LEFT OUTER JOIN {{ params.param_cr_base_views_dataset_name }}.ref_disease_assess_source AS rtt ON upper(rtrim(ssc.disease_assess_source_name)) = upper(rtrim(rtt.disease_assess_source_name))
