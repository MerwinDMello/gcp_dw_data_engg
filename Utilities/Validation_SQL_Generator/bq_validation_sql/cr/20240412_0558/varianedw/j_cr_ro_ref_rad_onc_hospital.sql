...
BEGIN
  ...
  SET srctablename = concat(srcdataset_id, '.', 'stg_dimhospitaldepartment');
...
WHERE ref_rad_onc_hospital.dw_last_update_date_time >= tableload_start_time - INTERVAL 1 MINUTE)
  );
