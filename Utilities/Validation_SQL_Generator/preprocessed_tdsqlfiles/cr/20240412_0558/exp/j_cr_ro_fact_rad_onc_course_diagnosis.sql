...
FROM
 ...
 (SELECT Source_Site_Id,
 Site_SK
 FROM EDWCR.Ref_Rad_Onc_Site) rs ON rs.Site_Sk=ra.Site_SK)ra ON dp.FactPatientDiagnosisID = ra.Source_Fact_Patient_Diagnosis_Id
 ...
 (SELECT Source_Site_Id,
 Site_SK
 FROM EDWCR.Ref_Rad_Onc_Site) rs1 ON rs1.Site_Sk=ra1.Site_SK)ra1 ON dp.DimCourseID = ra1.Source_Patient_Course_Id
 ...
 (SELECT Source_Site_Id,
 Site_SK
 FROM EDWCR.Ref_Rad_Onc_Site) rs2 ON rs2.Site_Sk=dc.Site_SK)dc ON dp.DimDiagnosisCodeID = dc.Source_Diagnosis_Code_Id
