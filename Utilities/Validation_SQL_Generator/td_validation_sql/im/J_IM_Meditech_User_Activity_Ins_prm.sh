...
export Job_Name='J_IM_Meditech_User_Activity_Ins'
export JOBNAME='J_IM_Meditech_User_Activity_Ins'

export AC_EXP_SQL_STATEMENT="select 'J_IM_Meditech_User_Activity_Ins' ||','||cast(zeroifnull(count(*)) as varchar(20)) ||',' as source_string from
 (
SELECT 
...
export AC_ACT_SQL_STATEMENT="select 'J_IM_Meditech_User_Activity_Ins' ||','||cast(zeroifnull(A.counts) as varchar(20)) ||',' as source_string from 
(
SELECT
	COUNT(*) as counts
