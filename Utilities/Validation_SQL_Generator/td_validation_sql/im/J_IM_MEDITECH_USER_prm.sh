...
export Job_Name='J_IM_MEDITECH_USER'
export JOBNAME='J_IM_MEDITECH_USER'

export AC_EXP_SQL_STATEMENT="select 'J_IM_MEDITECH_USER' ||','||cast(zeroifnull(count(*)) as varchar(20)) ||',' as source_string from
 (
SELECT DISTINCT 
...
export AC_ACT_SQL_STATEMENT="select 'J_IM_MEDITECH_USER' ||','||cast(zeroifnull(A.counts) as varchar(20)) ||',' as source_string from 
(
SELECT
	COUNT(*) as counts
