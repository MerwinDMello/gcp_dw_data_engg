export Job_Name='J_IM_AD_Account_Supplemental'
export JOBNAME='J_IM_AD_Account_Supplemental'
...
export AC_ACT_SQL_STATEMENT="select 'J_IM_AD_Account_Supplemental' ||','||cast(zeroifnull(A.counts) as varchar(20)) ||',' as source_string from 
(
SELECT
	COUNT(*) as counts
