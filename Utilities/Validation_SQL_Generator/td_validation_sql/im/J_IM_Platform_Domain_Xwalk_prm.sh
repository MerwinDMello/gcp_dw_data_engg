export Job_Name='J_IM_Platform_Domain_Xwalk'
export JOBNAME='J_IM_Platform_Domain_Xwalk'


export AC_EXP_SQL_STATEMENT="select 'J_IM_Platform_Domain_Xwalk' ||','||cast(zeroifnull(A.counts) as varchar(20)) ||',' AS SOURCE_STRING from 
(
...
export AC_ACT_SQL_STATEMENT="select 'J_IM_Platform_Domain_Xwalk' ||','||cast(zeroifnull(A.counts) as varchar(20)) ||',' AS SOURCE_STRING from 
(
 SELECT COUNT(*) as counts FROM
