...
export JOBNAME='J_MHB_vwUnits_stg'

#######Expected Parameter###################
export AC_EXP_INPUT_FILE='SRC_J_MHB_vwUnits_stg.txt'
...
export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_vwUnits_stgLoad'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING
