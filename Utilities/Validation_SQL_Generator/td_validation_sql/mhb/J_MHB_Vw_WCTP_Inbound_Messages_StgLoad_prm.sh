...
export JOBNAME='J_MHB_Vw_WCTP_Inbound_Messages_StgLoad'

#######Expected Parameter###################
export AC_EXP_INPUT_FILE='SRC_J_MHB_Vw_WCTP_Inbound_Messages_Stg.txt'
export P_EXP_Delimiter='|'
export P_EXP_Control_Total_Field='1'
export P_EXP_Number_of_Fields='30'
