...
export JOBNAME='J_MHB_Vw_Patient_Alert_Tracker_StgLoad'

#######Expected Parameter###################
export AC_EXP_INPUT_FILE='SRC_J_MHB_Vw_Patient_Alert_Tracker_Stg.txt'
...
export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Vw_Patient_Alert_Tracker_StgLoad'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING
