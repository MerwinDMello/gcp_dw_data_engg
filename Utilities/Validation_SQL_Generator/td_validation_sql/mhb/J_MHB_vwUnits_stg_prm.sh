...
FROM $DBname.dbo.vwUnits
where 
(LastTimeStamp > '${From_Date}' AND LastTimeStamp <= '${To_Date}')
)a"
...
export AC_ACT_INPUT_FILE='J_MHB_vwUnits_stg_'${DBname}'.txt' 
