...
export JOBNAME='J_MHB_Ref_MHB_Dynamic_Role'

export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Ref_MHB_Dynamic_Role'||','||CAST(Count(*) AS VARCHAR (20))||','
...
export AC_EXP_SQL_STATEMENT="SELECT 'J_MHB_Ref_MHB_Dynamic_Role'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING FROM
(
