...
export JOBNAME='J_MHB_Care_Attachment'



export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Care_Attachment'||','||CAST(Count(*) AS VARCHAR (20))||','
...
export AC_EXP_SQL_STATEMENT="SELECT 'J_MHB_Care_Attachment'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING FROM
(
SELECT 
