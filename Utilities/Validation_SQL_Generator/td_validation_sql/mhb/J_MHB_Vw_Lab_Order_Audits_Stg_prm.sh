...
export View_Name=vwLabOrderAudits 
...
Action,
Lab_Order_Item_Number,
 Lab_Order_Audit_DateTime,
'$DBname' As Databasename
FROM $DBname.dbo.vwLabOrderAudits
where 
...
export AC_ACT_INPUT_FILE='J_MHB_Vw_Lab_Order_Audits_Stg_'${DBname}'.txt' 
export P_ACT_Delimiter='|' 
export P_ACT_Control_Total_Field='1,'
export P_ACT_Number_of_Fields='19'
