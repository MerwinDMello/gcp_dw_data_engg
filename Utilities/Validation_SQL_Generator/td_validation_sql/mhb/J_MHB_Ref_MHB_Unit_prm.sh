...
export JOBNAME='J_MHB_Ref_MHB_Unit'

export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Ref_MHB_Unit'||','||CAST(Count(*) AS VARCHAR (20))||','
...
export AC_EXP_SQL_STATEMENT="SELECT 'J_MHB_Ref_MHB_Unit'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING FROM
(
