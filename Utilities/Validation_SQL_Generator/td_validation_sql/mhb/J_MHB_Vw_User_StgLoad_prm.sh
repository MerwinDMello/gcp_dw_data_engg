...
#######Expected Parameter###################
export AC_EXP_INPUT_FILE='SRC_J_MHB_Vw_User_Stg.txt'
export P_EXP_Delimiter='	'
export P_EXP_Control_Total_Field='1'
export P_EXP_Number_of_Fields='32'
export P_EXP_Control_Total_Type='1'

##########A/C Parameter#################

export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Vw_User_StgLoad'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING
