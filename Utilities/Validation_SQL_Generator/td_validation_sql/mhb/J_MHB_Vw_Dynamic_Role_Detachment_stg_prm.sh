...
export View_Name=vwDynamicRoleDetachment
...
FROM $DBname.dbo.vwDynamicRoleDetachment
where 
...
export AC_ACT_INPUT_FILE='J_MHB_Vw_Dynamic_Role_Detachment_stg_'${DBname}'.txt' 
