...
export JOBNAME='J_MHB_Vw_Dynamic_Care_Detachment_stg'

#######Expected Parameter###################
export AC_EXP_INPUT_FILE='SRC_J_MHB_Vw_Dynamic_Care_Detachment_stg.txt'
...
export AC_ACT_SQL_STATEMENT="SELECT 'J_MHB_Vw_Dynamic_Care_Detachment_stgLoad'||','||CAST(Count(*) AS VARCHAR (20))||','
AS SOURCE_STRING
