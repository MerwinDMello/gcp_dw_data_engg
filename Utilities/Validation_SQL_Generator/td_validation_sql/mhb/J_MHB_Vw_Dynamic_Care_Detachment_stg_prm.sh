...
export View_Name=vwDynamicCareDetachment
...
FROM $DBname.dbo.vwDynamicCareDetachment
where 
...
export AC_ACT_INPUT_FILE='J_MHB_Vw_Dynamic_Care_Detachment_stg'${DBname}'.txt' 
