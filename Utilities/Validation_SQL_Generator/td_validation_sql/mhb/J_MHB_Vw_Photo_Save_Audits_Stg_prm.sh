...
FROM (
SELECT	Trail_Id, Unit_Id, UnitName, UnitCode, Hospital, FacilityCode,
		User_Id, User_Name, User_Full_Name, User_Role, Patient_Id, Patient_Name,
		Patient_MRN, Patient_VisitNumber, Patient_FacilityCode, Photo_FileName,
		Photo_Save_DateTime,'$DBname' As Databasename
)a"
...
export AC_ACT_INPUT_FILE='J_MHB_Vw_Photo_Save_Audits_Stg_'${DBname}'.txt' 
