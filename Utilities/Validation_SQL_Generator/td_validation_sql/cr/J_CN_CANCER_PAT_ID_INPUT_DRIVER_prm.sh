...
export JOBNAME='J_CN_CANCER_PAT_ID_INPUT_DRIVER'

export AC_EXP_SQL_STATEMENT="SELECT 'J_CN_CANCER_PAT_ID_INPUT_DRIVER'||','|| cast(count(*) as varchar(20))||',' as SOURCE_STRING 
FROM 
(SELECT  
