export JOBNAME='J_CN_NAVQUE_PATIENT_TUMOR_DRIVER'

export AC_EXP_SQL_STATEMENT="SELECT 'J_CN_NAVQUE_PATIENT_TUMOR_DRIVER'||','|| cast(count(*) as varchar(20))||',' as SOURCE_STRING 
...
export AC_ACT_SQL_STATEMENT="select 'J_CN_NAVQUE_PATIENT_TUMOR_DRIVER'||','|| cast(count(*) as varchar(20))||',' as SOURCE_STRING 
FROM $NCR_TGT_SCHEMA.NAVQUE_PATIENT_TUMOR_DRIVER
where 
