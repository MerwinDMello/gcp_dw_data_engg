export JOBNAME='J_CR_Patient_Date_Driver'
...
export AC_ACT_SQL_STATEMENT="select 'J_CR_Patient_Date_Driver'||','|| cast(count(*) as varchar(20))||',' as SOURCE_STRING 
FROM $NCR_TGT_SCHEMA.CR_Patient_Date_Driver;"
