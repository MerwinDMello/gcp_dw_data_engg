...
export JOBNAME=''PBMAR390-30''

export AC_ACT_SQL_STATEMENT="Select 'PBMAR390-30' || ',' || 
...
export AC_EXP_SQL_STATEMENT="SELECT 'PBMAR390-30' || ',' || 
...
JOIN Edwfs.Fact_Facility FF
 ...
 LEFT OUTER JOIN edwpf.fact_rcom_ar_patient_level fp
