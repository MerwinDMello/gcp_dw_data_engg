...
export JOBNAME='j_ADA_Patient_Level_Detail'

export AC_ACT_SQL_STATEMENT="SELECT 'j_ADA_Patient_Level_Detail' || ',' || 
...
export AC_EXP_SQL_STATEMENT="SELECT 'j_ADA_Patient_Level_Detail' || ',' ||
