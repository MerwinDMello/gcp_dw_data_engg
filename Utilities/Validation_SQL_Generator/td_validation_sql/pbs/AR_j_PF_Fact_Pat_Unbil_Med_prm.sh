...
export JOBNAME='PBMAR390-50'

export AC_EXP_SQL_STATEMENT="Select  'PBMAR390-50'||','||trim(cast(zeroifnull(sum(du.unbilled_charge_amt)) as varchar(20))) ||','as Source_string
from 
...
export AC_ACT_SQL_STATEMENT="Select 'PBMAR390-50'||','|| trim(cast((zeroifnull(Sum(Unbilled_Gross_Med_Rec_Amt))) as varchar(30)) )||',' as Source_String
