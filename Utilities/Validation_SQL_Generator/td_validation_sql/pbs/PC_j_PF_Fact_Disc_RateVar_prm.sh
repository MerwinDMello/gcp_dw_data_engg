...
echo $logon > /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
echo ".export report file=/etl/jfmd/PBS/PC/Scripts/PBMPC310.txt;" >> /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
echo $select_statement >> /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
echo ".export reset;" >> /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
echo $logoff >> /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
echo ".QUIT" >> /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
chmod 777 /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
##chmod 777 /etl/jfmd/PBS/PC/Scripts/PBMPC310.txt


###  Bteq call to run the insert query ###
bteq < /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql >>/dev/null
RC=$?
if [ $RC = 0 ] 
then
   rm /etl/jfmd/PBS/PC/Scripts/PBMPC310.sql
else
   echo "PBMPC310.sql executed Failed"
   exit 99
fi

sed '1,2d' /etl/jfmd/PBS/PC/Scripts/PBMPC310.txt > /etl/jfmd/PBS/PC/Scripts/PBMPC310_new.txt
count1=$(wc -l </etl/jfmd/PBS/PC/Scripts/PBMPC310_new.txt)
rm /etl/jfmd/PBS/PC/Scripts/PBMPC310.txt
...
export AC_EXP_SQL_STATEMENT="Select  'PBMPC310'||','||
...
SELECT 
  ...
  WHERE D.Log_ID <> 'MSP'
    ...
    AND D.Coid in (select coid from edwpbs.parallon_client_detail where Company_code='CHP')
...
echo "if part"
rm /etl/jfmd/PBS/PC/Scripts/PBMPC310_new.txt
##exit 0
