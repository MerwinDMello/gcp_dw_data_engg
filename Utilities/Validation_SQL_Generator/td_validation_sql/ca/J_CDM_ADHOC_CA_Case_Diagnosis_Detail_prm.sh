export JOBNAME='J_CDM_ADHOC_CA_Case_Diagnosis_Detail'
...
export AC_ACT_SQL_STATEMENT="select '$JOBNAME'  || ','  || cast(COUNT(*) as varchar(30)) ||',' as SOURCE_STRING FROM (
Select * from  EDWCDM.CA_Case_Diagnosis_Detail
