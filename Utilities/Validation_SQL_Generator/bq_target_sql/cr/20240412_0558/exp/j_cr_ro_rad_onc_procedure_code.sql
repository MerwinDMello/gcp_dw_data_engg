    ...
    (
      SELECT
        ...
        FROM
          (
            SELECT
                CAST(bqutil.fn.cw_td_normalize_number(stg_dimprocedurecode.dimsiteid) as INT64) AS dimsiteid,
                CAST(bqutil.fn.cw_td_normalize_number(stg_dimprocedurecode.dimprocedurecodeid) as INT64) AS dimprocedurecodeid,
                ...
                CAST(bqutil.fn.cw_td_normalize_number(stg_dimprocedurecode.logid) as INT64) AS log_id,
                CAST(bqutil.fn.cw_td_normalize_number(stg_dimprocedurecode.runid) as INT64) AS run_id
              FROM
