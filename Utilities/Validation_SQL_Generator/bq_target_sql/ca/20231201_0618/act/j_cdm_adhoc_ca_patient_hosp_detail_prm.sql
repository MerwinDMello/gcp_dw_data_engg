...
-- Source: eim-clin-pdoc-ccda-dev-0001/ca_bulk_conversion_validation/20231201_0618/input/act/j_cdm_adhoc_ca_patient_hosp_detail_prm.sql
...
SELECT
  ...
  FROM
    (
      SELECT
          ca_patient_hosp_detail.*
        FROM
          `hca-hin-dev-cur-clinical`.edwcdm.ca_patient_hosp_detail
