...
-- Source: eim-clin-pdoc-ccda-dev-0001/ca_bulk_conversion_validation/20231201_0618/input/exp/j_cdm_adhoc_ca_patient_case_prm.sql
        ...
        FROM
          (
            SELECT DISTINCT
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_cases_stg AS stg
