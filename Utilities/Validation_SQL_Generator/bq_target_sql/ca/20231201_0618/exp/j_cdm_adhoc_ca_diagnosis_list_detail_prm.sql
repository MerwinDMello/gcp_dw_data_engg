              ...
              FROM
                (
                  ...
                  SELECT DISTINCT
                      ...
                      CAST(bqutil.fn.cw_td_normalize_number(stg.kingdom) as INT64) AS diagnosis_list_detail_measure_value_text,
                  ...
                  SELECT DISTINCT
                      ...
                      CAST(bqutil.fn.cw_td_normalize_number(stg.phylum) as INT64) AS diagnosis_list_detail_measure_value_text,
                      CAST(NULL as INT64) AS diagnosis_list_detail_measure_value_num,
                      'C' AS source_system_code,
                      timestamp_trunc(current_timestamp(), SECOND) AS dw_last_update_date_time
                    FROM
                  ...
                  SELECT DISTINCT
                      ...
                      CAST(bqutil.fn.cw_td_normalize_number(stg.ipccc) as INT64) AS diagnosis_list_detail_measure_value_text,
                      CAST(NULL as INT64) AS diagnosis_list_detail_measure_value_num,
                      'C' AS source_system_code,
                      timestamp_trunc(current_timestamp(), SECOND) AS dw_last_update_date_time
                    FROM
                  ...
                  SELECT DISTINCT
                    ...
                    FROM
                      `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_diagnosislist_stg AS stg
                      INNER JOIN `hca-hin-dev-cur-clinical`.edwcdm.ca_server AS ser ON upper(stg.full_server_nm) = upper(ser.server_name)
                    WHERE stg.funddx33 IS NOT NULL
                ) AS wrk
