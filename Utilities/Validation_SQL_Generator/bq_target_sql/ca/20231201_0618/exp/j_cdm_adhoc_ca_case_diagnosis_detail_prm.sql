    ...
    (
      SELECT DISTINCT
        ...
        FROM
          (
            SELECT DISTINCT
                cardioaccess_diagnosis_stg.diagnosisid,
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_diagnosis_stg
            ...
            SELECT DISTINCT
              ...
              FROM
                ...
                CROSS JOIN UNNEST(ARRAY[
                  substr(cardioaccess_diagnosis_stg.olddiagname, 1, 55)
                ]) AS diagnosis_detail_measure_value_text
            ...
            SELECT DISTINCT
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_diagnosis_stg
                CROSS JOIN UNNEST(ARRAY[
                  substr(cardioaccess_diagnosis_stg.class, 1, 55)
                ]) AS diagnosis_detail_measure_value_text
              WHERE diagnosis_detail_measure_value_text IS NOT NULL
            UNION DISTINCT
            SELECT DISTINCT
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_diagnosis_stg
              WHERE cardioaccess_diagnosis_stg.recur IS NOT NULL
          ) AS a
    ) AS b
;
