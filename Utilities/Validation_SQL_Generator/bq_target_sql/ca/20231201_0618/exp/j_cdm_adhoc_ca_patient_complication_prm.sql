        ...
        FROM
          (
            SELECT
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_complications_stg AS stg
                ...
                LEFT OUTER JOIN (
                  SELECT
                    ...
                    FROM
                      ...
                      INNER JOIN `hca-hin-dev-cur-clinical`.edwcdm.ca_server AS s ON trim(format('%11d', c.server_sk)) = trim(format('%11d', s.server_sk))
