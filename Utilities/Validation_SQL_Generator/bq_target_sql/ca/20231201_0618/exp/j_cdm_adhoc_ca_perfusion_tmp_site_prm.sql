    ...
    (
      SELECT DISTINCT
        ...
        FROM
          (
            SELECT
                cardioaccess_perfusion_stg.perfusionnumber,
              ...
              FROM
                `hca-hin-dev-cur-clinical`.edwcdm_staging.cardioaccess_perfusion_stg
            UNION DISTINCT
            SELECT
                cardioaccess_perfusion_stg.perfusionnumber,
                cardioaccess_perfusion_stg.casenumber,
        ...
        WHERE unions.lowest_core_tmp_amt IS NOT NULL
    ) AS b
;
