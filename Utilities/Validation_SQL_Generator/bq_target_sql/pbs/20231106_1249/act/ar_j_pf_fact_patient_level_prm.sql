...
-- Source: eim-parallon-cs-datamig-dev-0002/pbs_bulk_conversion_validation/20231106_1249/input/act/ar_j_pf_fact_patient_level_prm.sql
...
SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpf.fact_rcom_ar_patient_level AS arp
