...
SELECT
  ...
  END
   ...
   AND upper(arp.coid) IN(
    SELECT
        upper(max(pass_current.co_id)) AS co_id
      FROM
        `hca-hin-dev-cur-parallon`.edwpbs_staging.pass_current
