    ...
    (
      SELECT
        ...
        FROM
          ...
          LEFT OUTER JOIN `hca-hin-dev-cur-parallon`.edwpf_base_views.fact_rcom_pars_discrepancy AS disc ON disc.date_sid = CASE
