...
-- Source: gs://eim-comp-cs-datamig-dev-0002/im_bulk_conversion_validation/20240904_0246/input/exp/j_im_ref_im_domain_pk.sql
...
SELECT
  ...
  FROM
    (
      SELECT
          count(DISTINCT upper(ref_pk_data_base_instance.pk_database_instance_code)) AS counts
        FROM
