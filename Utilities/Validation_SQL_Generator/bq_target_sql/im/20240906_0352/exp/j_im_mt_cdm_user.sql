...
-- Source: gs://eim-comp-cs-datamig-dev-0002/im_bulk_conversion_validation/20240906_0352/input/exp/j_im_mt_cdm_user.sql
  ...
  FROM
    (
      SELECT
        ...
        FROM
          `hca-hin-dev-cur-comp`.edwim_staging.mt_cdm_user_3_4 AS t1
          INNER JOIN `hca-hin-dev-cur-comp`.edwim_staging.mt_cdm_user_mnem AS t2 ON t1.role_plyr_sk = t2.role_plyr_sk
          INNER JOIN `hca-hin-dev-cur-comp`.edwim_staging.mt_cdm_user_coid AS t3 ON t1.role_plyr_sk = t3.role_plyr_sk
    ) AS a
;
