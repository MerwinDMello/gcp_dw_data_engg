...
-- Source: gs://eim-comp-cs-datamig-dev-0002/im_bulk_conversion_validation/20240906_0352/input/exp/j_im_meditech_user.sql
      ...
      SELECT DISTINCT
          ...
          CASE
            WHEN upper(rtrim(t1.actv_ind)) = 'Y' THEN CASE
              WHEN rtrim(t2.prctnr_fclt_role_cd) IN(
