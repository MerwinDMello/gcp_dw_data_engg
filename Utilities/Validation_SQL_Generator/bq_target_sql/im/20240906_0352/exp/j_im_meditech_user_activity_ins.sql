...
-- Source: gs://eim-comp-cs-datamig-dev-0002/im_bulk_conversion_validation/20240906_0352/input/exp/j_im_meditech_user_activity_ins.sql
                ...
                LEFT OUTER JOIN (
                  SELECT
                    ...
                    FROM
                        ...
                        SELECT DISTINCT
                          ...
                          FROM
                            ...
                            CROSS JOIN UNNEST(ARRAY[
                              CASE
                                 upper(rtrim(prctnr_actvt_dtl.prctnr_alias_nm))
                      ...
                      ) AS t2 ON rtrim(t2.ntwk_mnem_cs) = rtrim(t1_0.im_domain_name)
