...
-- Source: gs://eim-comp-cs-datamig-dev-0002/im_bulk_conversion_validation/20240906_0352/input/exp/j_im_mt_cl_user_activity.sql
...
FROM
  (SELECT clinical_user_patient_audit.company_code AS company_code,
   ...
   FROM `hca-hin-dev-cur-comp`.auth_base_views.clinical_user_patient_audit QUALIFY row_number() OVER (PARTITION BY network_mnemonic_cs,
                                                                                                                   user_mnemonic
