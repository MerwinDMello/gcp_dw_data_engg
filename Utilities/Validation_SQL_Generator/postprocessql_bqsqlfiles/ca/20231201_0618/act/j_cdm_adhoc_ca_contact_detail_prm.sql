...
-- Source: eim-clin-pdoc-ccda-dev-0001/ca_bulk_conversion_validation/20231201_0618/input/act/j_cdm_adhoc_ca_contact_detail_prm.sql
...
FROM
  (SELECT ca_contact_detail.*
   FROM `hca-hin-dev-cur-clinical`.edwcdm.ca_contact_detail
