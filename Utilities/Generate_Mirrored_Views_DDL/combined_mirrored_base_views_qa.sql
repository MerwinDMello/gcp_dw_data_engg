...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ada_patient_level_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ar_transaction AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.armap_recoveries AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.calculated_payor_overpayment
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.claim_reprocessing_tool_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.cm_patient_encounter_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_action_history_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_agency_placement_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_charity_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_doc_req_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_encounter_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_encounter_detail_crnt
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_letter_request_list
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_payer_bal_threshold
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.collection_user
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.contact_savvy_acct_activity
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.contact_savvy_dialer_call_log
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.contact_savvy_multimedia_info
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.denial_eom
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.denial_inventory_list
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_account
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_account_status
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_admission_type AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_age AS SELECT
    dim_age.age_sid,
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_appeal_code
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_appeal_disp AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_appeal_root_cause AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_bdgt_organization
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_bdgt_scenario
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_bdgt_time
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_bdgt_value
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_bdgt_year
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_credit_status
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_denial_type AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_department
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_discrepancy_type AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_dollar_stratification
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_employee
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_esb_organization
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_los AS SELECT
    dim_los.los_sid,
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_metric
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_payor AS SELECT
    dim_payor.payor_sid,
    dim_payor.payor_id,
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_pbs_drg
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_rcm_org_level AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_rcm_organization
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.dim_source
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.discrepancy_inventory_analysis
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_appeal_root_cause_dim AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_dcrp_unit_cost_year_dim AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_dollar_strf_dim AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_payor_dim
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_reason_code_dim AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.eis_scenario_dim
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.erequest_inventory
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.erequest_productivity_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.facility_dimension_eom
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_aged_ar_denial
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_ar_patient_level_daily
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_dmr_metric
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_hsc_delinquency_rate
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_patient_fin_class_conv
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_patient_finc_class_eom
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_patient_iplan_conv
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_ar_hospital_level AS SELECT
    a.unit_num_sid,
    a.scenario_sid,
    a.week_of_month_sid,
    a.date_sid,
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_ar_pat_fc_level
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_ar_patient_level
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_pars_credit_balance
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_pars_credit_refund
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_pars_dcrp_all
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_pars_denial
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_rcom_pars_discrepancy AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.fact_unbilled_inventory
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.hps_pat_payment_link_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_appeal_disposition AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_remittance_additional_payee
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_remittance_delete
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_remittance_other_claim_related_info
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_remittance_provider_serv
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_remittance_secn_rendering_prov
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.junc_vendor_payor AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.lu_dmr_code AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.lu_erequest_source_system
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.lu_rcm_level_security AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.lu_same_store
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.lu_year_month_past AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.mcaid_elig_placement_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.mcaid_eligibility_acct_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.net_revenue_impact_analysis
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.net_revenue_impact_credit_refund
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.net_revenue_impact_denial
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.net_revenue_impact_discrepancy_inventory
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.net_revenue_impact_underpayment_pmt_act
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.parallon_client_detail AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.pass_eom_lp AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.pass_eow
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.pat_balance_liability
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.patient_account_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.patient_insurance
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_compliance_appeal_asst_inventory
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_compliance_credit_inventory
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_compliance_legacy_denial
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_compliance_payor_address
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_resolution_recovery_adj_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payment_resolution_recovery_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payor_audit_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payor_employer
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.payor_eom
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.post_write_off_rebill_hist_dtl
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.prebill_denial_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.process_run_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.rcom_payor_dimension_eom
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_ada_facility_metric
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_collection_claim_status
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_collection_claim_status_scat
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_collection_pool_assignment
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_collection_recall_reason
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_mcaid_applied_program
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_mcaid_elig_phase
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_mcaid_eligibility_status
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_payor_spcl_report_list
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_provider_service
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_additional_payee
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_cob_carrier
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_corrected_priority_payor
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_oth_subscriber_info
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_other_claim_related_info
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_payee
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_payor
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_rendering_provider
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_remittance_subscriber_info
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_request_file
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_secn_remittance_rendering_provider
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.ref_sr_vendor_user
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_claim
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_claim_carc
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_payment
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_plb_adj
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_service
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_service_carc
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_service_hcpcs_modifier
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.remittance_service_rarc
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.rpt_ar_ada_detail
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.sma_rate_calculation
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_ar_cash_collections_lp AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_ar_metric AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_ar_metric_other AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_cash_metric AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_medicaid_conv_rate AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_pc_metric AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_pc_metric_other AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_rcm_mc_discrepancy_rate AS SELECT
...
CREATE OR REPLACE VIEW `hca-hin-qa-cur-parallon`.edwpbs_base_views_copy.smry_rcm_unbilled_inventory AS SELECT
