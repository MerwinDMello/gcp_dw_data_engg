...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.smry_ar_cash_collections_lp AS SELECT
  ...
  FROM
    {{ params.param_pbs_core_dataset_name }}.smry_ar_cash_collections_lp
;
