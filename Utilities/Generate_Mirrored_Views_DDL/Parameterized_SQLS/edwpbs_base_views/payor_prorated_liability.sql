...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.payor_prorated_liability AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.payor_prorated_liability
;
