...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.ref_collection_recall_reason
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.ref_collection_recall_reason
  ;
