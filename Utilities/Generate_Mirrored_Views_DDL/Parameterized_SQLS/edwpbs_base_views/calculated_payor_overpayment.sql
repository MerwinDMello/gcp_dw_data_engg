...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.calculated_payor_overpayment
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.calculated_payor_overpayment
  ;
