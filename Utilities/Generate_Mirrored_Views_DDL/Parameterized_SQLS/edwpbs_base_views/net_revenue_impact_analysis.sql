...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.net_revenue_impact_analysis
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.net_revenue_impact_analysis
  ;
