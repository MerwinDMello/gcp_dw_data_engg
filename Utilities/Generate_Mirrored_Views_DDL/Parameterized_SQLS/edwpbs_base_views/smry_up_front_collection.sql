...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.smry_up_front_collection AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.ar_up_front_collection
;
