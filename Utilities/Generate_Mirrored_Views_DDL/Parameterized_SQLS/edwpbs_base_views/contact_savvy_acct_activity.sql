...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.contact_savvy_acct_activity
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.contact_savvy_acct_activity
  ;
