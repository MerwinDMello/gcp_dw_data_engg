...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.smry_rcm_unbilled_inventory AS SELECT
  ...
  FROM
    {{ params.param_pbs_core_dataset_name }}.smry_rcm_unbilled_inventory
;
