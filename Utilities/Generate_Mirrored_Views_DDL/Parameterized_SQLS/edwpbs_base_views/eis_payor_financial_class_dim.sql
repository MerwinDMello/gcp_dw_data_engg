...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.eis_payor_financial_class_dim AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.eis_payor_financial_class_dim AS a
;
