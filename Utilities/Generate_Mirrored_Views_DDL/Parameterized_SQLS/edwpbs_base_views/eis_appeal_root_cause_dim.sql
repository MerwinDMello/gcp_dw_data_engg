...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.eis_appeal_root_cause_dim AS SELECT
  ...
  FROM
    {{ params.param_pbs_core_dataset_name }}.eis_appeal_root_cause_dim
;
