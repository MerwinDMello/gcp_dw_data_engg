...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.junc_remittance_other_claim_related_info
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.junc_remittance_other_claim_related_info
  ;
