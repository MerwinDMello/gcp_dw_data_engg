...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.smry_ar_cash_collections AS SELECT
  ...
  FROM
    {{ params.param_auth_base_views_dataset_name }}.smry_ar_cash_collections
;
