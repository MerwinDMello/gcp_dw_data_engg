...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.collection_agency_placement_detail
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.collection_agency_placement_detail
  ;
