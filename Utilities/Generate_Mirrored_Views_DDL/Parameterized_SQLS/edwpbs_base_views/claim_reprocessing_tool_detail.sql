...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.claim_reprocessing_tool_detail
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.claim_reprocessing_tool_detail
  ;
