...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.contact_savvy_dialer_call_log
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.contact_savvy_dialer_call_log
  ;
