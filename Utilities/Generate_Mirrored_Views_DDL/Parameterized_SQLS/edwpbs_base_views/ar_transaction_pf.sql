...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.ar_transaction_pf AS SELECT
    bv.company_code,
    bv.coid,
    ...
    bv.hps_order_id
  FROM
    {{ params.param_auth_base_views_dataset_name }}.ar_transaction AS bv
;
