...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.fact_rcom_pars_discrepancy AS SELECT
  ...
  FROM
    {{ params.param_pbs_core_dataset_name }}.fact_rcom_pars_discrepancy
;
