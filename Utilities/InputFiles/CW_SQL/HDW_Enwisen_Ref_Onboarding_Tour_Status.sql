...
-- Source: eim-cs-da-gmek-5764-dev/HRG/Bteq_Source_Files/MERWIN/Enwisen/HDW_Enwisen_Ref_Onboarding_Tour_Status.sql
...
BEGIN
  SET _ERROR_CODE = 0;
  MERGE INTO `hca-hin-dev-cur-hr`.edwhr.ref_onboarding_tour_status AS tgt USING (
    SELECT
        CASE
          ...
          ELSE (
            SELECT
              ...
              FROM
                `hca-hin-dev-cur-hr`.edwhr_base_views.ref_onboarding_tour_status
      ...
      FROM
        ...
        LEFT OUTER JOIN `hca-hin-dev-cur-hr`.edwhr_base_views.ref_onboarding_tour_status AS tgt_0 ON tgt_0.tour_status_text = stg.tour_status_text
