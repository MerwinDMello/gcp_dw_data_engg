...
%truncate(D.CSAPPPRLASTACTIVITY,60) AS Appeal_Concuity_Previous_Activity,
...
SQLUser.HCACCOUNT.CSACLSTCLRSPPROB AS Last_Claim_Status_Rspn_Pblm_Code,
SQLUser.HCACCOUNT.CSACLSTCLRSPCD as CI_Stat_Last_Response_Status,
CASE
...
End CI_Stat_Last_Response_Subcategory,
--SQLUser.HCACCOUNT.CSACLSTCLRSPSUBCAT as CI_Stat_Last_Response_Subcategory,
SQLUser.HCACCOUNT.CSACLSTCLRSPTYPE as CI_Stat_Last_Response_Type,
...
,SQLUser.HCENCOUNTER.CSENNOTICEOFADM AS Notice_Of_Admission 
,SQLUser.HCENCOUNTER.CSENNOTICEOFEPISODE AS Notice_Of_Election 
,CAST(SQLUser.HCENCOUNTER.CSENEPISODEID AS DECIMAL(15,0))AS Episode_ID 
,CAST(SQLUser.HCENCOUNTER.CSENPATIENTID AS DECIMAL(15,0)) AS Patient_ID 
,SQLUser.HCACCOUNT.CSACERISA AS ERISA_Ind 
