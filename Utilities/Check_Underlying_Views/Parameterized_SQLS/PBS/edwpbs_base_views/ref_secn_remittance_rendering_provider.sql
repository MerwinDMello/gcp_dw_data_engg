...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.ref_secn_remittance_rendering_provider
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.ref_secn_remittance_rendering_provider
  ;
