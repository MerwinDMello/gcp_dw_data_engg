...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.fact_ar_patient_level_daily
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.fact_ar_patient_level_daily
  ;
