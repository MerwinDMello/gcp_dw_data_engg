...
CREATE OR REPLACE VIEW {{ params.param_pbs_base_views_dataset_name }}.mcaid_eligibility_acct_dtl
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_core_dataset_name }}.mcaid_eligibility_acct_dtl
  ;
