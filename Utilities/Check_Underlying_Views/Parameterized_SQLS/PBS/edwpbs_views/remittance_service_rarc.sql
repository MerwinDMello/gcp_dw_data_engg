...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.remittance_service_rarc
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.remittance_service_rarc AS a
