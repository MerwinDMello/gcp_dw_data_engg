...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.ref_collection_claim_status_scat
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.ref_collection_claim_status_scat AS a
  ;
