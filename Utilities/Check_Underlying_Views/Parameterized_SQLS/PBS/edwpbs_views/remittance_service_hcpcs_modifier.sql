...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.remittance_service_hcpcs_modifier
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.remittance_service_hcpcs_modifier AS a
  ;
