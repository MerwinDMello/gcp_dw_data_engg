...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.dim_discrepancy_type AS SELECT
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.dim_discrepancy_type
;
