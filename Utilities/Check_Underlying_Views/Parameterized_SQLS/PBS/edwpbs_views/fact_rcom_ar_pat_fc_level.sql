...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_rcom_ar_pat_fc_level
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.fact_rcom_ar_pat_fc_level AS a
