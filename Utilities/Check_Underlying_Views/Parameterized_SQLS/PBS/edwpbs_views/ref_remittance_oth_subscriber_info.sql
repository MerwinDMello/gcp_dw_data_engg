...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.ref_remittance_oth_subscriber_info
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.ref_remittance_oth_subscriber_info AS a
  ;
