...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.smry_pc_metric_other AS SELECT
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.smry_pc_metric_other
;
