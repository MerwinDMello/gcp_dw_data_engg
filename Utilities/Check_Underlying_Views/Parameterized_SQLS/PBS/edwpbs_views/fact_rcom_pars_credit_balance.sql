...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_rcom_pars_credit_balance
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.fact_rcom_pars_credit_balance AS a
