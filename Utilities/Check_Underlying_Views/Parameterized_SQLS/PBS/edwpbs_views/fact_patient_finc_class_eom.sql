...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_patient_finc_class_eom
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.fact_patient_finc_class_eom AS a
