...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_dmr_metric AS SELECT
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.fact_dmr_metric
...
SELECT
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.fact_dmr_metric AS a
    INNER JOIN {{ params.param_pbs_base_views_dataset_name }}.fact_dmr_metric AS b ON upper(a.service_type_name) = upper(b.service_type_name)
