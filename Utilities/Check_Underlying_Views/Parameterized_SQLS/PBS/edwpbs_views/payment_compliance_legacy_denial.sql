...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.payment_compliance_legacy_denial
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.payment_compliance_legacy_denial AS a
