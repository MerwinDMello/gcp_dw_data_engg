...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.remittance_service_carc
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.remittance_service_carc AS a
