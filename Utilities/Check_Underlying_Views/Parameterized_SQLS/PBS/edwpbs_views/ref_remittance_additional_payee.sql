...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.ref_remittance_additional_payee
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.ref_remittance_additional_payee AS a
  ;
