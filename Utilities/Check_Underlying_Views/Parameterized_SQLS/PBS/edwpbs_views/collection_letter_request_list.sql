...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.collection_letter_request_list
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.collection_letter_request_list AS a
