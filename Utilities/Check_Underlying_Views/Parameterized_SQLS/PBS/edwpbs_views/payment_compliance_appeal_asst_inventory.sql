...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.payment_compliance_appeal_asst_inventory
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.payment_compliance_appeal_asst_inventory AS a
