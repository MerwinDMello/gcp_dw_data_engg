...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_patient_fin_class_conv
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.fact_patient_fin_class_conv AS a
