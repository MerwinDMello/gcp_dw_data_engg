...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/erequest_inventory.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.erequest_inventory
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.erequest_inventory AS a
    ...
    WHERE upper(trim(upper(a.request_status_code))) = 'O'
  ;
