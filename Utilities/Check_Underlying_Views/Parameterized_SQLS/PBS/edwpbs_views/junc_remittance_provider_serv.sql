...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.junc_remittance_provider_serv
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.junc_remittance_provider_serv AS a
  ;
