...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.collection_payer_bal_threshold
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.collection_payer_bal_threshold AS a
