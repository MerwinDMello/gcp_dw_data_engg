...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.cm_patient_encounter_detail
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.cm_patient_encounter_detail AS a
