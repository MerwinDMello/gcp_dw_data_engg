...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.ref_mcaid_eligibility_status
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.ref_mcaid_eligibility_status AS a
  ;
