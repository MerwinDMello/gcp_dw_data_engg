...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.fact_ar_patient_level_daily
  ...
  AS SELECT
      ...
      ROUND(a.copay_deduct_amt, 3, 'ROUND_HALF_EVEN') AS copay_deduct_amt,
      a.source_system_code,
      a.dw_last_update_time
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.fact_ar_patient_level_daily AS a
