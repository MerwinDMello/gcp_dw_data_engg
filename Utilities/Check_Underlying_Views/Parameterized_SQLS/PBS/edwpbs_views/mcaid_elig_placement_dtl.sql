...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.mcaid_elig_placement_dtl
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.mcaid_elig_placement_dtl AS a
