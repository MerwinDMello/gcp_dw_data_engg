...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.lu_rcm_level_security AS SELECT
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.lu_rcm_level_security
;
