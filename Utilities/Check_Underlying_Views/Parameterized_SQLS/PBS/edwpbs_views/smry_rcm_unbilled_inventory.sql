...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.smry_rcm_unbilled_inventory AS SELECT
    a.coid,
    a.company_code,
    a.payor_sid,
    a.patient_type_sid,
  ...
  FROM
    {{ params.param_pbs_base_views_dataset_name }}.smry_rcm_unbilled_inventory AS a
