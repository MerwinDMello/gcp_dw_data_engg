...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.payment_resolution_recovery_adj_dtl
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.payment_resolution_recovery_adj_dtl AS a
