...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.net_revenue_impact_underpayment_pmt_act
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.net_revenue_impact_underpayment_pmt_act AS a
