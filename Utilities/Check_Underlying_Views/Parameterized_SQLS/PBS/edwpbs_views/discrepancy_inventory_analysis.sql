...
CREATE OR REPLACE VIEW {{ params.param_pbs_views_dataset_name }}.discrepancy_inventory_analysis
  ...
  AS SELECT
    ...
    FROM
      {{ params.param_pbs_base_views_dataset_name }}.discrepancy_inventory_analysis AS a
