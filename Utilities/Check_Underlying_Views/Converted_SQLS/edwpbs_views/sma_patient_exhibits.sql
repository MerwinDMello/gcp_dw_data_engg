...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/sma_patient_exhibits.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.sma_patient_exhibits AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.sma_patient_exhibits
;
