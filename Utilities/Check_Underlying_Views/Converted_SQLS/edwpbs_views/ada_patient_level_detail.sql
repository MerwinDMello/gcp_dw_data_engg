...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.ada_patient_level_detail
  ...
  AS SELECT
    ...
    FROM
      `hca-hin-dev-cur-parallon`.edwpbs_base_views.ada_patient_level_detail AS a
