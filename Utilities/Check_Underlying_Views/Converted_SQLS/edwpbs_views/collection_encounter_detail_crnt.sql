...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.collection_encounter_detail_crnt
  ...
  AS SELECT
    ...
    FROM
      `hca-hin-dev-cur-parallon`.edwpbs_base_views.collection_encounter_detail_crnt AS a
