...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.patient_account_detail_lvl AS SELECT
    ROUND(pa.patient_dw_id, 0, 'ROUND_HALF_EVEN') AS patient_dw_id,
    pa.company_code,
    pa.coid,
    pa.sub_unit_num,
    ...
    ROUND(pa.patient_person_dw_id, 0, 'ROUND_HALF_EVEN') AS patient_person_dw_id,
    ROUND(pa.patient_address_dw_id, 0, 'ROUND_HALF_EVEN') AS patient_address_dw_id,
    pa.admission_date,
    pa.discharge_date,
    pa.final_bill_date,
    pa.los_day_cnt,
    ...
    pa.stmt_issue_date,
    ROUND(pa.patient_allowance_amt, 3, 'ROUND_HALF_EVEN') AS patient_allowance_amt,
    ROUND(pa.patient_adj_amt, 3, 'ROUND_HALF_EVEN') AS patient_adj_amt,
    ROUND(pa.non_billable_adj_amt, 3, 'ROUND_HALF_EVEN') AS non_billable_adj_amt,
    ROUND(pa.non_billable_charge_amt, 3, 'ROUND_HALF_EVEN') AS non_billable_charge_amt,
    ROUND(pa.patient_balance_amt, 3, 'ROUND_HALF_EVEN') AS patient_balance_amt,
    ROUND(pa.last_patient_pmt_amt, 3, 'ROUND_HALF_EVEN') AS last_patient_pmt_amt,
    pa.last_patient_pmt_date,
    pa.pmt_arng_stmt_freq,
    pa.pmt_arng_start_date,
    ROUND(pa.previous_due_amt, 3, 'ROUND_HALF_EVEN') AS previous_due_amt,
    ROUND(pa.current_due_amt, 3, 'ROUND_HALF_EVEN') AS current_due_amt,
    ROUND(pa.patient_overdue_amt, 3, 'ROUND_HALF_EVEN') AS patient_overdue_amt,
    ROUND(pa.patient_min_due_amt, 3, 'ROUND_HALF_EVEN') AS patient_min_due_amt,
    ROUND(pa.total_patient_pmt_amt, 3, 'ROUND_HALF_EVEN') AS total_patient_pmt_amt,
    ROUND(pa.total_charge_amt, 3, 'ROUND_HALF_EVEN') AS total_charge_amt,
    ROUND(pa.total_account_balance_amt, 3, 'ROUND_HALF_EVEN') AS total_account_balance_amt,
    ROUND(pa.total_pmt_amt, 3, 'ROUND_HALF_EVEN') AS total_pmt_amt,
    ROUND(pa.total_allowance_amt, 3, 'ROUND_HALF_EVEN') AS total_allowance_amt,
    ROUND(pa.total_write_off_amt, 3, 'ROUND_HALF_EVEN') AS total_write_off_amt,
    ROUND(pa.total_adj_amt, 3, 'ROUND_HALF_EVEN') AS total_adj_amt,
    pa.stmt_cnt,
    ...
    ROUND(pi_1.payor_dw_id, 0, 'ROUND_HALF_EVEN') AS ins1_payor_dw_id,
    ROUND(pi_2.payor_dw_id, 0, 'ROUND_HALF_EVEN') AS ins2_payor_dw_id,
    ROUND(pi_3.payor_dw_id, 0, 'ROUND_HALF_EVEN') AS ins3_payor_dw_id,
    ...
    ROUND(pi_1.financial_class_code, 0, 'ROUND_HALF_EVEN') AS ins1_financial_class_code,
    ROUND(pi_2.financial_class_code, 0, 'ROUND_HALF_EVEN') AS ins2_financial_class_code,
    ROUND(pi_3.financial_class_code, 0, 'ROUND_HALF_EVEN') AS ins3_financial_class_code,
    ...
    ROUND(pi_1.address_dw_id, 0, 'ROUND_HALF_EVEN') AS ins1_address_dw_id,
    ROUND(pi_2.address_dw_id, 0, 'ROUND_HALF_EVEN') AS ins2_address_dw_id,
    ROUND(pi_3.address_dw_id, 0, 'ROUND_HALF_EVEN') AS ins3_address_dw_id,
    pi_1.log_id AS ins1_log_id,
    pi_2.log_id AS ins2_log_id,
    pi_3.log_id AS ins3_log_id,
    ROUND(pi_1.allowance_amt, 3, 'ROUND_HALF_EVEN') AS ins1_allowance_amt,
    ROUND(pi_2.allowance_amt, 3, 'ROUND_HALF_EVEN') AS ins2_allowance_amt,
    ROUND(pi_3.allowance_amt, 3, 'ROUND_HALF_EVEN') AS ins3_allowance_amt,
    ROUND(pi_1.adj_amt, 3, 'ROUND_HALF_EVEN') AS ins1_adj_amt,
    ROUND(pi_2.adj_amt, 3, 'ROUND_HALF_EVEN') AS ins2_adj_amt,
    ROUND(pi_3.adj_amt, 3, 'ROUND_HALF_EVEN') AS ins3_adj_amt,
    ROUND(pi_1.payor_balance_amt, 3, 'ROUND_HALF_EVEN') AS ins1_payor_balance_amt,
    ROUND(pi_2.payor_balance_amt, 3, 'ROUND_HALF_EVEN') AS ins2_payor_balance_amt,
    ROUND(pi_3.payor_balance_amt, 3, 'ROUND_HALF_EVEN') AS ins3_payor_balance_amt,
    ROUND(pi_1.last_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins1_last_pmt_rcvd_amt,
    ROUND(pi_2.last_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins2_last_pmt_rcvd_amt,
    ROUND(pi_3.last_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins3_last_pmt_rcvd_amt,
    ...
    ROUND(pi_1.total_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins1_total_pmt_rcvd_amt,
    ROUND(pi_2.total_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins2_total_pmt_rcvd_amt,
    ROUND(pi_3.total_pmt_rcvd_amt, 3, 'ROUND_HALF_EVEN') AS ins3_total_pmt_rcvd_amt,
    ROUND(pi_1.gross_reimbursement_amt, 3, 'ROUND_HALF_EVEN') AS ins1_gross_reimbursement_amt,
    ROUND(pi_2.gross_reimbursement_amt, 3, 'ROUND_HALF_EVEN') AS ins2_gross_reimbursement_amt,
    ROUND(pi_3.gross_reimbursement_amt, 3, 'ROUND_HALF_EVEN') AS ins3_gross_reimbursement_amt,
    ROUND(pi_1.gross_reimbursement_var_amt, 3, 'ROUND_HALF_EVEN') AS ins1_gross_reimbursement_var_amt,
    ROUND(pi_2.gross_reimbursement_var_amt, 3, 'ROUND_HALF_EVEN') AS ins2_gross_reimbursement_var_amt,
    ROUND(pi_3.gross_reimbursement_var_amt, 3, 'ROUND_HALF_EVEN') AS ins3_gross_reimbursement_var_amt,
    ROUND(pi_1.payor_liability_amt, 3, 'ROUND_HALF_EVEN') AS ins1_payor_liability_amt,
    ROUND(pi_2.payor_liability_amt, 3, 'ROUND_HALF_EVEN') AS ins2_payor_liability_amt,
    ROUND(pi_3.payor_liability_amt, 3, 'ROUND_HALF_EVEN') AS ins3_payor_liability_amt,
  ...
  FROM
    ...
    INNER JOIN `hca-hin-dev-cur-parallon`.edwpf_base_views.secref_facility AS b ON upper(pa.company_code) = upper(b.company_code)
     AND upper(pa.coid) = upper(b.co_id)
