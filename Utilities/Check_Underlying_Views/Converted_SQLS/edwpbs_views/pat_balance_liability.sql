...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.pat_balance_liability
  ...
  AS SELECT
    ...
    FROM
      ...
      INNER JOIN `hca-hin-dev-cur-parallon`.edwpf_base_views.secref_facility AS b ON upper(a.coid) = upper(b.co_id)
