...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/ar_transaction_legacy.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.ar_transaction_legacy AS SELECT
    bv.company_code,
    bv.coid,
