...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/clinical_patient_transfer.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.clinical_patient_transfer AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.clinical_patient_transfer
;
