...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/patient_procedure_crnt.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.patient_procedure_crnt AS SELECT
    a.coid,
    a.company_code,
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.patient_procedure_mv_pf AS a
