...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/junc_vendor_payor.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.junc_vendor_payor AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.junc_vendor_payor
;
