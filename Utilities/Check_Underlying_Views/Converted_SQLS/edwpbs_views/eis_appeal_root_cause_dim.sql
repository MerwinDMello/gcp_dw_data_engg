...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/eis_appeal_root_cause_dim.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.eis_appeal_root_cause_dim AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.eis_appeal_root_cause_dim
;
