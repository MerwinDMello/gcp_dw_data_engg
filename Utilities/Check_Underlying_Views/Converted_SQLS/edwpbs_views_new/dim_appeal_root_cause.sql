...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.dim_appeal_root_cause AS SELECT
    bv.appeal_root_cause_sid,
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.dim_appeal_root_cause AS bv
;
