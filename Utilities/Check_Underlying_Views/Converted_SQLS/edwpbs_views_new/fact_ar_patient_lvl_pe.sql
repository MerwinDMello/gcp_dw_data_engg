...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_views/fact_ar_patient_lvl_pe.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.fact_ar_patient_lvl_pe AS SELECT
    a.date_sid,
    a.scenario_sid,
    a.patient_type_sid,
    peom.derived_patient_type_code,
  ...
  FROM
    ...
    LEFT OUTER JOIN `hca-hin-dev-cur-parallon`.edwpf_base_views.pass_eom AS peom ON peom.pat_acct_num = a.patient_sid
     AND peom.coid = a.coid
     AND CAST(bqutil.fn.cw_td_normalize_number(peom.rptg_period) as FLOAT64) = a.date_sid
