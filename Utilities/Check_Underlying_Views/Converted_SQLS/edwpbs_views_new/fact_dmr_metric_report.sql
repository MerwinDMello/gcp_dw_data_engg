...
SELECT
  ...
  GROUP BY upper(a.service_type_name), 2, 3, 4, 5, 7, 8
UNION ALL
SELECT
    a.service_type_name,
    a.fact_lvl_code,
  ...
  FROM
    ...
    INNER JOIN (
      SELECT
        ...
        GROUP BY upper(fact_dmr_metric_all_lvl.service_type_name), 2, 3, 4, 5, fact_dmr_metric_all_lvl.dmr_metric_code, 7, 8
...
SELECT
  ...
  GROUP BY upper(fact_dmr_metric_all_lvl.service_type_name), 2, 3, 4, fact_dmr_metric_all_lvl.dmr_day_month_ind, fact_dmr_metric_all_lvl.dmr_metric_code, 7, 8
UNION ALL
SELECT
    a.service_type_name,
    a.fact_lvl_code,
  ...
  FROM
    (
      SELECT
        ...
        GROUP BY upper(fact_dmr_metric_all_lvl.service_type_name), 2, 3, 4, 5, 6, 7, 8, 9
    ) AS a
    INNER JOIN (
      SELECT
          max(fact_dmr_metric_all_lvl.service_type_name) AS service_type_name,
    ...
    (
      SELECT
        ...
        WHERE upper(fact_dmr_metric_all_lvl.dmr_metric_code) = '10'
         ...
         AND upper(fact_dmr_metric_all_lvl.dmr_fin_class_code) <> 'NA'
         AND upper(fact_dmr_metric_all_lvl.dmr_code) = 'NA'
        GROUP BY upper(fact_dmr_metric_all_lvl.service_type_name), 2, 3, 4, 5, 6, 7, 8
    ) AS a
    INNER JOIN (
      SELECT
          max(fact_dmr_metric_all_lvl.service_type_name) AS service_type_name,
...
SELECT
  ...
  GROUP BY upper(fact_dmr_metric_all_lvl.service_type_name), 2, 3, 4, 5, 6, fact_dmr_metric_all_lvl.dmr_code, 8
UNION ALL
SELECT
    max(fact_dmr_metric_all_lvl.service_type_name) AS service_type_name,
    fact_dmr_metric_all_lvl.fact_lvl_code,
  ...
  FROM
    (
      SELECT
        ...
        GROUP BY upper(a_0.service_type_name), 2, 3, 4, 5, 7, 8
    ) AS a
    CROSS JOIN (
      SELECT
          max(a_0.service_type_name) AS service_type_name,
