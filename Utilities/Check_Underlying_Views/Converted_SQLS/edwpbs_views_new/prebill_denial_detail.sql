...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_views.prebill_denial_detail AS SELECT
    a.company_code,
    a.coid,
    a.rptg_date,
    a.account_id,
    ...
    a.total_charge_amt,
    a.expected_reimbursement_amt,
    a.actual_reimbursement_amt,
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.prebill_denial_detail AS a
