...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.ref_ssi_responsible_dept_pf AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpf_base_views.ref_ssi_responsible_dept
;
