...
SELECT
  ...
  FROM
    ...
    LEFT OUTER JOIN `hca-hin-dev-cur-parallon`.edwpbs_base_views.eis_patient_fin_class_dim AS efd ON upper(sc.financial_class_code) = upper(substr(efd.patient_financial_class_alias, 1, 2))
  WHERE sc.iplan_id = 0
  GROUP BY 1, 2, 3, 4, 5, 6, 7, 8, 9
UNION DISTINCT
SELECT
