...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_base_views/smry_sla_scorecard.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.smry_sla_scorecard AS SELECT
    ...
    ROUND(smry_sla_scorecard.metric_actual_value, 5, 'ROUND_HALF_EVEN') AS metric_actual_value,
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.smry_sla_scorecard
;
