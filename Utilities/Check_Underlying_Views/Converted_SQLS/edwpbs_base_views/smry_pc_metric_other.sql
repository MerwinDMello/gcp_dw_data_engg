...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.smry_pc_metric_other AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.smry_pc_metric_other
;
