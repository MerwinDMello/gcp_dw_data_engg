...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.fact_ar_patient_level_daily
  ...
  AS SELECT
    ...
    FROM
      `hca-hin-dev-cur-parallon`.edwpbs.fact_ar_patient_level_daily
  ;
