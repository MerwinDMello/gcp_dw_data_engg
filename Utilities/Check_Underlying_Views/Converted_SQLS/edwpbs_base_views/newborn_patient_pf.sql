...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.newborn_patient_pf AS SELECT
    ROUND(newborn_patient.patient_dw_id, 0, 'ROUND_HALF_EVEN') AS patient_dw_id,
    ROUND(newborn_patient.pat_acct_num, 0, 'ROUND_HALF_EVEN') AS pat_acct_num,
    ROUND(newborn_patient.mother_patient_dw_id, 0, 'ROUND_HALF_EVEN') AS mother_patient_dw_id,
