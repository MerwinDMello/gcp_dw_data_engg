...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_base_views/ar_transaction_pf.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.ar_transaction_pf AS SELECT
    bv.company_code,
    bv.coid,
    ...
    bv.hps_order_id
  FROM
    `hca-hin-dev-cur-parallon`.edwpf_base_views.ar_transaction AS bv
;
