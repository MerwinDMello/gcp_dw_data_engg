...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.payment_compliance_appeal_asst_inventory AS SELECT
    payment_compliance_appeal_asst_inventory.patient_dw_id,
    ...
    payment_compliance_appeal_asst_inventory.pat_acct_num,
    ...
    payment_compliance_appeal_asst_inventory.payor_financial_class_code,
    ...
    payment_compliance_appeal_asst_inventory.appeal_amt,
    payment_compliance_appeal_asst_inventory.denied_charge_amt,
    payment_compliance_appeal_asst_inventory.total_charge_amt,
