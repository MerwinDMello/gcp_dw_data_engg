...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.cm_patient_encounter_detail AS SELECT
    cm_patient_encounter_detail.patient_dw_id,
    cm_patient_encounter_detail.midas_encounter_id,
    cm_patient_encounter_detail.company_code,
    cm_patient_encounter_detail.coid,
    cm_patient_encounter_detail.pat_acct_num,
    cm_patient_encounter_detail.midas_acct_num,
    cm_patient_encounter_detail.payor_dw_id_ins1,
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.cm_patient_encounter_detail
;
