...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.ref_collection_claim_status AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.ref_collection_claim_status
;
