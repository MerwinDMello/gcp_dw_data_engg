...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.prebill_denial_detail AS SELECT
    ...
    prebill_denial_detail.financial_class_code,
    prebill_denial_detail.national_provider_id,
    ...
    prebill_denial_detail.attending_physician_tax_id,
    ...
    prebill_denial_detail.total_charge_amt,
    prebill_denial_detail.expected_reimbursement_amt,
    prebill_denial_detail.actual_reimbursement_amt,
