...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.collection_charity_detail AS SELECT
    collection_charity_detail.reporting_date,
    collection_charity_detail.patient_dw_id,
    ...
    collection_charity_detail.pat_acct_num,
    ...
    collection_charity_detail.charity_denial_amt,
    collection_charity_detail.denial_reason_code,
    collection_charity_detail.discount_amt,
    collection_charity_detail.discount_pct,
    ...
    collection_charity_detail.household_income_amt,
    ...
    collection_charity_detail.sa_income_amt,
    ...
    collection_charity_detail.resp_party_weekly_income_amt,
    collection_charity_detail.resp_party_monthly_income_amt,
    collection_charity_detail.resp_party_yearly_income_amt,
    collection_charity_detail.spouse_weekly_income_amt,
    collection_charity_detail.spouse_monthly_income_amt,
    collection_charity_detail.spouse_yearly_income_amt,
    collection_charity_detail.source_system_code,
    collection_charity_detail.dw_last_update_date_time
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.collection_charity_detail
;
