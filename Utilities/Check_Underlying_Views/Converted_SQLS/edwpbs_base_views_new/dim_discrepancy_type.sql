...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.dim_discrepancy_type AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.dim_discrepancy_type
;
