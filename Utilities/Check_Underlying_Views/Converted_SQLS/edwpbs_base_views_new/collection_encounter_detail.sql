...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.collection_encounter_detail AS SELECT
    collection_encounter_detail.patient_dw_id,
    ...
    collection_encounter_detail.pat_acct_num,
    ...
    collection_encounter_detail.cc_activity_type_id,
    collection_encounter_detail.cc_prev_activity_type_id,
    collection_encounter_detail.total_billed_charge_amt,
    collection_encounter_detail.non_bill_charge_amt,
    collection_encounter_detail.encounter_balance_amt,
    collection_encounter_detail.original_balance_amt,
    collection_encounter_detail.current_balance_amt,
    collection_encounter_detail.liability_level_code,
    collection_encounter_detail.total_adjustment_amt,
    collection_encounter_detail.total_payment_amt,
    collection_encounter_detail.placement_amt,
    ...
    collection_encounter_detail.appeal_source_system_id,
    ...
    collection_encounter_detail.appeal_amt,
    ...
    collection_encounter_detail.insgn_account_balance_amt,
    collection_encounter_detail.episode_id,
    collection_encounter_detail.patient_id,
