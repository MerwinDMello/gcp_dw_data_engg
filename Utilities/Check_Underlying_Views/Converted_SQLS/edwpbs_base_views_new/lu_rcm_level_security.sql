...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.lu_rcm_level_security AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.lu_rcm_level_security
;
