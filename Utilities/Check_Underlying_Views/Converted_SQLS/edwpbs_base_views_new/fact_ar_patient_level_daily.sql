...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.fact_ar_patient_level_daily AS SELECT
    ...
    fact_ar_patient_level_daily.patient_sid,
    ...
    fact_ar_patient_level_daily.ar_patient_amt,
    fact_ar_patient_level_daily.ar_insurance_amt,
    fact_ar_patient_level_daily.write_off_amt,
    fact_ar_patient_level_daily.total_collect_amt,
    fact_ar_patient_level_daily.billed_patient_cnt,
    fact_ar_patient_level_daily.discharge_to_billing_day_cnt,
    fact_ar_patient_level_daily.gross_charge_amt,
    fact_ar_patient_level_daily.prorated_liability_sys_adj_amt,
    fact_ar_patient_level_daily.late_charge_credit_amt,
    fact_ar_patient_level_daily.late_charge_debit_amt,
    fact_ar_patient_level_daily.payor_prorated_liability_amt,
    fact_ar_patient_level_daily.payor_payment_amt,
    fact_ar_patient_level_daily.payor_adjustment_amt,
    fact_ar_patient_level_daily.payor_contractual_amt,
    fact_ar_patient_level_daily.payor_denial_amt,
    fact_ar_patient_level_daily.payor_denial_cnt,
    fact_ar_patient_level_daily.payor_expected_payment_amt,
    fact_ar_patient_level_daily.payor_discrepancy_ovr_pmt_amt,
    fact_ar_patient_level_daily.payor_discrepancy_undr_pmt_amt,
    fact_ar_patient_level_daily.payor_up_front_collection_amt,
    fact_ar_patient_level_daily.payor_rebill_cnt,
    fact_ar_patient_level_daily.payor_bill_cnt,
    fact_ar_patient_level_daily.unbilled_gross_med_rec_amt,
    fact_ar_patient_level_daily.unbilled_gross_bus_ofc_amt,
    fact_ar_patient_level_daily.copay_deduct_amt,
