...
-- Source: internal_metastore/db_hca-hin-dev-cur-parallon/schema_edwpbs_base_views/fact_rcom_pars_dcrp_all_esb.memory
-- Translated from: Teradata
-- Translated to: BigQuery

CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.fact_rcom_pars_dcrp_all_esb AS SELECT
    a.date_sid,
    a.patient_dw_id,
    a.payor_dw_id,
    ...
    b.year_end_date AS cost_year_end_date,
    a.patient_sid,
  ...
  FROM
    ...
    INNER JOIN `hca-hin-dev-cur-parallon`.edwpbs_base_views.eis_dcrp_unit_year_dim AS b ON a.unit_num_sid = b.unit_num_sid
...
SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs_base_views.fact_rcom_pars_discrepancy AS a
    INNER JOIN `hca-hin-dev-cur-parallon`.edwpbs_base_views.eis_dcrp_unit_year_dim AS p ON a.unit_num_sid = p.unit_num_sid
     AND a.source_sid = p.source_sid
     AND a.discrepancy_creation_date BETWEEN p.year_beg_date AND p.year_end_date
