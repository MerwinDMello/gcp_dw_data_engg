...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.remittance_claim AS SELECT
    remittance_claim.claim_guid,
    remittance_claim.payment_guid,
    remittance_claim.patient_dw_id,
    ...
    remittance_claim.total_charge_amt,
    remittance_claim.mpi_calc_charge_amt,
    remittance_claim.payment_amt,
    remittance_claim.ep_calc_denial_amount,
    remittance_claim.ep_calc_contractual_adj_amt,
    remittance_claim.mpi_contractual_adj_amt,
    remittance_claim.corrected_contractual_adj_amt,
    remittance_claim.net_benefit_amt,
    remittance_claim.covered_charge_amt,
    remittance_claim.mpi_calc_payor_previous_payment_amt,
    remittance_claim.ep_calc_noncovered_charge_amt,
    remittance_claim.mpi_calc_non_covered_charge_amt,
    remittance_claim.ep_calc_deductible_amt,
    remittance_claim.mpi_calc_deductible_amt,
    remittance_claim.ep_calc_blood_deductible_amt,
    remittance_claim.ep_calc_coinsurance_amt,
    remittance_claim.mpi_calc_coinsurance_amt,
    remittance_claim.ep_calc_primary_payor_payment_amt,
    remittance_claim.patient_liability_amount,
    remittance_claim.capital_amt,
    remittance_claim.ep_calc_discount_amt,
    remittance_claim.disproportionate_share_amt,
    remittance_claim.drg_disproportionate_share_amt,
    remittance_claim.drg_amt,
    remittance_claim.drg_code,
    remittance_claim.mpi_calc_drg_code,
    remittance_claim.mpi_calc_drg_grouper_code,
    remittance_claim.federal_specific_drg_amt,
    remittance_claim.hospital_specific_drg_amt,
    remittance_claim.drg_weight_amt,
    remittance_claim.hcpcs_charge_amt,
    remittance_claim.hcpcs_payment_amt,
    remittance_claim.indirect_medical_education_amt,
    remittance_claim.indirect_teaching_amt,
    remittance_claim.interest_amt,
    remittance_claim.ep_calc_lab_charge_amt,
    remittance_claim.ep_calc_lab_payment_amt,
    remittance_claim.pps_opr_federal_specific_drg_amt,
    remittance_claim.mpi_calc_non_billed_charge_amt,
    remittance_claim.mpi_calc_net_benefit_amt,
    remittance_claim.ep_calc_non_payable_professional_fee_amt,
    remittance_claim.old_capital_amt,
    remittance_claim.operating_outlier_amt,
    remittance_claim.outlier_amt,
    remittance_claim.outpatient_reimibursement_rate_amt,
    remittance_claim.ep_calc_therapy_charge_amt,
    remittance_claim.ep_calc_therapy_payment_amt,
    remittance_claim.pps_capital_outlier_amt,
    remittance_claim.ins_covered_day_cnt,
    remittance_claim.ep_calc_covered_day_cnt,
    remittance_claim.noncovered_day_cnt,
    remittance_claim.cost_report_day_cnt,
    remittance_claim.discharge_fraction_pct,
    ...
    remittance_claim.mia_pps_capital_exception_amt,
