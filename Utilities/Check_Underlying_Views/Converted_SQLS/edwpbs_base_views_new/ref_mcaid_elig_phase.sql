...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.ref_mcaid_elig_phase AS SELECT
  ...
  FROM
    `hca-hin-dev-cur-parallon`.edwpbs.ref_mcaid_elig_phase
;
