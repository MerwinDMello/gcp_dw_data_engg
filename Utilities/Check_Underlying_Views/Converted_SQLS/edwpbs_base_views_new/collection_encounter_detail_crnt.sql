...
CREATE VIEW IF NOT EXISTS `hca-hin-dev-cur-parallon`.edwpbs_base_views.collection_encounter_detail_crnt AS SELECT
    collection_encounter_detail_crnt.patient_dw_id,
    ...
    collection_encounter_detail_crnt.pat_acct_num,
    ...
    collection_encounter_detail_crnt.payor_dw_id,
    ...
    collection_encounter_detail_crnt.cc_activity_type_id,
    collection_encounter_detail_crnt.cc_prev_activity_type_id,
    collection_encounter_detail_crnt.total_billed_charge_amt,
    collection_encounter_detail_crnt.non_bill_charge_amt,
    collection_encounter_detail_crnt.encounter_balance_amt,
    collection_encounter_detail_crnt.original_balance_amt,
    collection_encounter_detail_crnt.current_balance_amt,
    collection_encounter_detail_crnt.liability_level_code,
    collection_encounter_detail_crnt.total_adjustment_amt,
    collection_encounter_detail_crnt.total_payment_amt,
    collection_encounter_detail_crnt.placement_amt,
    ...
    collection_encounter_detail_crnt.appeal_source_system_id,
    ...
    collection_encounter_detail_crnt.appeal_amt,
    ...
    collection_encounter_detail_crnt.insgn_account_balance_amt,
    collection_encounter_detail_crnt.episode_id,
    collection_encounter_detail_crnt.patient_id,
