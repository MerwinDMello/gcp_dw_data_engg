...
#    JOBNAME
#    P_EXP_Number_of_Fields
#    P_EXP_Control_Total_Field
#    P_EXP_Field_End_Positions
#
################################################################################
LAYOUT_FILENAME="${IDF_DIR}/AggregationLayout_exp_$JOBNAME.txt"

echo "========================================================================="
echo "Running with the following parameters:"
echo "JOBNAME = ${JOBNAME}"
echo "P_EXP_Control_Total_Field = ${P_EXP_Control_Total_Field}"
echo "P_EXP_Number_of_Fields = ${P_EXP_Number_of_Fields}"
echo "P_EXP_Control_Total_type = ${P_EXP_Control_Total_type}"
echo "P_EXP_Delimiter = ${P_EXP_Delimiter}"
echo "P_EXP_Field_End_Positions = ${P_EXP_Field_End_Positions}"
echo "========================================================================="
echo 
...
then
   ...
   RECORD_LAYOUT="/RECORDLAYOUT AggregationInputLayout {"
    ...
    END_POSITIONS=(`echo ${P_EXP_Field_End_Positions} | sed -e 's|,| |g' `)
    ...
    FIELD_NUM=1
    FIELD_POSITIONS=`echo ${P_EXP_Control_Total_Field} | sed -e 's|,| |g'`
...
#	FIELD_NUM=$((FIELD_NUM +1))
    ...
    DUMMY_COUNT=1
    while [ ${DUMMY_COUNT} -le ${P_EXP_Number_of_Fields} ]
    do 
       if [ $DUMMY_COUNT -gt 1 ]
       then
           RECORD_LAYOUT="${RECORD_LAYOUT},"
